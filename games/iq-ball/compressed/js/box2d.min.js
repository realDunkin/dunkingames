...
box2d.b2DistanceVV=function(a,b){var c=a.x-b.x;a=a.y-b.y;return Math.sqrt(c*c+a*a)};box2d.b2DistanceSquaredVV=function(a,b){var c=a.x-b.x;a=a.y-b.y;return c*c+a*a};box2d.b2NegV=function(a,b){b.x=-a.x;b.y=-a.y;return b};box2d.b2Vec3=function(a,b,c){this.x=a||0;this.y=b||0;this.z=c||0};box2d.b2Vec3.prototype.x=0;box2d.b2Vec3.prototype.y=0;box2d.b2Vec3.prototype.z=0;box2d.b2Vec3.ZERO=new box2d.b2Vec3;box2d.b2Vec3.s_t0=new box2d.b2Vec3;
...
box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints=function(a){var b=a.velocities[this.m_indexA].v,c=a.velocities[this.m_indexA].w,d=a.velocities[this.m_indexB].v,e=a.velocities[this.m_indexB].w,f=this.m_invMassA,g=this.m_invMassB,h=this.m_invIA,k=this.m_invIB;var l=0===h+k;if(this.m_enableMotor&&this.m_limitState!==box2d.b2LimitState.e_equalLimits&&!1===l){var m=e-c-this.m_motorSpeed;m*=-this.m_motorMass;var n=this.m_motorImpulse;var p=a.step.dt*this.m_maxMotorTorque;this.m_motorImpulse=box2d.b2Clamp(this.m_motorImpulse+
m,-p,p);m=this.m_motorImpulse-n;c-=h*m;e+=k*m}this.m_enableLimit&&this.m_limitState!==box2d.b2LimitState.e_inactiveLimit&&!1===l?(n=box2d.b2SubVV(box2d.b2AddVCrossSV(d,e,this.m_rB,box2d.b2Vec2.s_t0),box2d.b2AddVCrossSV(b,c,this.m_rA,box2d.b2Vec2.s_t1),box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_Cdot1),m=this.m_mass.Solve33(n.x,n.y,e-c,box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_impulse3).SelfNeg(),this.m_limitState===box2d.b2LimitState.e_equalLimits?this.m_impulse.SelfAdd(m):
this.m_limitState===box2d.b2LimitState.e_atLowerLimit?(l=this.m_impulse.z+m.z,0>l?(l=-n.x+this.m_impulse.z*this.m_mass.ez.x,n=-n.y+this.m_impulse.z*this.m_mass.ez.y,l=this.m_mass.Solve22(l,n,box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_reduced),m.x=l.x,m.y=l.y,m.z=-this.m_impulse.z,this.m_impulse.x+=l.x,this.m_impulse.y+=l.y,this.m_impulse.z=0):this.m_impulse.SelfAdd(m)):this.m_limitState===box2d.b2LimitState.e_atUpperLimit&&(l=this.m_impulse.z+m.z,0<l?(l=-n.x+this.m_impulse.z*this.m_mass.ez.x,
n=-n.y+this.m_impulse.z*this.m_mass.ez.y,l=this.m_mass.Solve22(l,n,box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_reduced),m.x=l.x,m.y=l.y,m.z=-this.m_impulse.z,this.m_impulse.x+=l.x,this.m_impulse.y+=l.y,this.m_impulse.z=0):this.m_impulse.SelfAdd(m)),l=box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_P.SetXY(m.x,m.y),b.SelfMulSub(f,l),c-=h*(box2d.b2CrossVV(this.m_rA,l)+m.z),d.SelfMulAdd(g,l),e+=k*(box2d.b2CrossVV(this.m_rB,l)+m.z)):(m=box2d.b2SubVV(box2d.b2AddVCrossSV(d,e,this.m_rB,
...
box2d.b2RevoluteJoint.prototype.SolvePositionConstraints=function(a){var b=a.positions[this.m_indexA].c,c=a.positions[this.m_indexA].a,d=a.positions[this.m_indexB].c,e=a.positions[this.m_indexB].a,f=this.m_qA.SetAngleRadians(c),g=this.m_qB.SetAngleRadians(e),h=0;var k=0===this.m_invIA+this.m_invIB;if(this.m_enableLimit&&this.m_limitState!==box2d.b2LimitState.e_inactiveLimit&&!1===k){k=e-c-this.m_referenceAngle;var l=0;this.m_limitState===box2d.b2LimitState.e_equalLimits?(k=box2d.b2Clamp(k-this.m_lowerAngle,
...
var n=a.step.dt*this.m_maxMotorForce;this.m_motorImpulse=box2d.b2Clamp(this.m_motorImpulse+l,-n,n);l=this.m_motorImpulse-m;n=box2d.b2MulSV(l,this.m_axis,box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P);m=l*this.m_a1;l*=this.m_a2;b.SelfMulSub(f,n);c-=h*m;d.SelfMulAdd(g,n);e+=k*l}n=box2d.b2DotVV(this.m_perp,box2d.b2SubVV(d,b,box2d.b2Vec2.s_t0))+this.m_s2*e-this.m_s1*c;var p=e-c;this.m_enableLimit&&this.m_limitState!==box2d.b2LimitState.e_inactiveLimit?(l=box2d.b2DotVV(this.m_axis,box2d.b2SubVV(d,
...
this.m_K.ez.x,-p-(this.m_impulse.z-m.z)*this.m_K.ez.y,box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_f2r),n.x+=m.x,n.y+=m.y,this.m_impulse.x=n.x,this.m_impulse.y=n.y,l.x=this.m_impulse.x-m.x,l.y=this.m_impulse.y-m.y,l.z=this.m_impulse.z-m.z,n=box2d.b2AddVV(box2d.b2MulSV(l.x,this.m_perp,box2d.b2Vec2.s_t0),box2d.b2MulSV(l.z,this.m_axis,box2d.b2Vec2.s_t1),box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P),m=l.x*this.m_s1+l.y+l.z*this.m_a1,l=l.x*this.m_s2+l.y+l.z*this.m_a2):(l=
this.m_K.Solve22(-n,-p,box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_df2),this.m_impulse.x+=l.x,this.m_impulse.y+=l.y,n=box2d.b2MulSV(l.x,this.m_perp,box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P),m=l.x*this.m_s1+l.y,l=l.x*this.m_s2+l.y);b.SelfMulSub(f,n);c-=h*m;d.SelfMulAdd(g,n);a.velocities[this.m_indexA].w=c;a.velocities[this.m_indexB].w=e+k*l};box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P=new box2d.b2Vec2;
...
box2d.b2PrismaticJoint.prototype.SolvePositionConstraints=function(a){var b=a.positions[this.m_indexA].c,c=a.positions[this.m_indexA].a,d=a.positions[this.m_indexB].c,e=a.positions[this.m_indexB].a,f=this.m_qA.SetAngleRadians(c),g=this.m_qB.SetAngleRadians(e),h=this.m_invMassA,k=this.m_invMassB,l=this.m_invIA,m=this.m_invIB,n=box2d.b2MulRV(f,this.m_lalcA,this.m_rA),p=box2d.b2MulRV(g,this.m_lalcB,this.m_rB);var q=box2d.b2SubVV(box2d.b2AddVV(d,p,box2d.b2Vec2.s_t0),box2d.b2AddVV(b,n,box2d.b2Vec2.s_t1),
box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_d);var r=box2d.b2MulRV(f,this.m_localXAxisA,this.m_axis),t=box2d.b2CrossVV(box2d.b2AddVV(q,n,box2d.b2Vec2.s_t0),r),g=box2d.b2CrossVV(p,r),f=box2d.b2MulRV(f,this.m_localYAxisA,this.m_perp),u=box2d.b2CrossVV(box2d.b2AddVV(q,n,box2d.b2Vec2.s_t0),f),w=box2d.b2CrossVV(p,f),x=box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_impulse,z=box2d.b2DotVV(f,q),A=e-c-this.m_referenceAngle,n=box2d.b2Abs(z),p=box2d.b2Abs(A);var v=!1;var y=0;this.m_enableLimit&&
(q=box2d.b2DotVV(r,q),box2d.b2Abs(this.m_upperTranslation-this.m_lowerTranslation)<2*box2d.b2_linearSlop?(y=box2d.b2Clamp(q,-box2d.b2_maxLinearCorrection,box2d.b2_maxLinearCorrection),n=box2d.b2Max(n,box2d.b2Abs(q)),v=!0):q<=this.m_lowerTranslation?(y=box2d.b2Clamp(q-this.m_lowerTranslation+box2d.b2_linearSlop,-box2d.b2_maxLinearCorrection,0),n=box2d.b2Max(n,this.m_lowerTranslation-q),v=!0):q>=this.m_upperTranslation&&(y=box2d.b2Clamp(q-this.m_upperTranslation-box2d.b2_linearSlop,0,box2d.b2_maxLinearCorrection),
n=box2d.b2Max(n,q-this.m_upperTranslation),v=!0));if(v){v=l*u+m*w;var E=l*u*t+m*w*g;q=l+m;0===q&&(q=1);var F=l*t+m*g,D=h+k+l*t*t+m*g*g,B=this.m_K3;B.ex.SetXYZ(h+k+l*u*u+m*w*w,v,E);B.ey.SetXYZ(v,q,F);B.ez.SetXYZ(E,F,D);x=B.Solve33(-z,-A,-y,x)}else v=l*u+m*w,q=l+m,0===q&&(q=1),y=this.m_K2,y.ex.SetXY(h+k+l*u*u+m*w*w,v),y.ey.SetXY(v,q),z=y.Solve(-z,-A,box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_impulse1),x.x=z.x,x.y=z.y,x.z=0;r=box2d.b2AddVV(box2d.b2MulSV(x.x,f,box2d.b2Vec2.s_t0),box2d.b2MulSV(x.z,
r,box2d.b2Vec2.s_t1),box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_P);t=x.x*u+x.y+x.z*t;g=x.x*w+x.y+x.z*g;b.SelfMulSub(h,r);c-=l*t;d.SelfMulAdd(k,r);a.positions[this.m_indexA].a=c;a.positions[this.m_indexB].a=e+m*g;return n<=box2d.b2_linearSlop&&p<=box2d.b2_angularSlop};box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_d=new box2d.b2Vec2;box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_impulse=new box2d.b2Vec3;
...
this.m_bodyC.m_invMass;this.m_mD=this.m_bodyD.m_invMass;this.m_iA=this.m_bodyA.m_invI;this.m_iB=this.m_bodyB.m_invI;this.m_iC=this.m_bodyC.m_invI;this.m_iD=this.m_bodyD.m_invI;var b=a.velocities[this.m_indexA].v,c=a.velocities[this.m_indexA].w,d=a.positions[this.m_indexB].a,e=a.velocities[this.m_indexB].v,f=a.velocities[this.m_indexB].w,g=a.positions[this.m_indexC].a,h=a.velocities[this.m_indexC].v,k=a.velocities[this.m_indexC].w;var l=a.positions[this.m_indexD].a;var m=a.velocities[this.m_indexD].v,
n=a.velocities[this.m_indexD].w,p=this.m_qA.SetAngleRadians(a.positions[this.m_indexA].a),d=this.m_qB.SetAngleRadians(d),q=this.m_qC.SetAngleRadians(g),g=this.m_qD.SetAngleRadians(l);this.m_mass=0;this.m_typeA===box2d.b2JointType.e_revoluteJoint?(this.m_JvAC.SetZero(),this.m_JwC=this.m_JwA=1,this.m_mass+=this.m_iA+this.m_iC):(l=box2d.b2MulRV(q,this.m_localAxisC,box2d.b2GearJoint.prototype.InitVelocityConstraints.s_u),box2d.b2SubVV(this.m_localAnchorC,this.m_lcC,this.m_lalcC),q=box2d.b2MulRV(q,this.m_lalcC,
box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rC),box2d.b2SubVV(this.m_localAnchorA,this.m_lcA,this.m_lalcA),p=box2d.b2MulRV(p,this.m_lalcA,box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rA),this.m_JvAC.Copy(l),this.m_JwC=box2d.b2CrossVV(q,l),this.m_JwA=box2d.b2CrossVV(p,l),this.m_mass+=this.m_mC+this.m_mA+this.m_iC*this.m_JwC*this.m_JwC+this.m_iA*this.m_JwA*this.m_JwA);this.m_typeB===box2d.b2JointType.e_revoluteJoint?(this.m_JvBD.SetZero(),this.m_JwD=this.m_JwB=this.m_ratio,this.m_mass+=
this.m_ratio*this.m_ratio*(this.m_iB+this.m_iD)):(l=box2d.b2MulRV(g,this.m_localAxisD,box2d.b2GearJoint.prototype.InitVelocityConstraints.s_u),box2d.b2SubVV(this.m_localAnchorD,this.m_lcD,this.m_lalcD),p=box2d.b2MulRV(g,this.m_lalcD,box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rD),box2d.b2SubVV(this.m_localAnchorB,this.m_lcB,this.m_lalcB),d=box2d.b2MulRV(d,this.m_lalcB,box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rB),box2d.b2MulSV(this.m_ratio,l,this.m_JvBD),this.m_JwD=this.m_ratio*
box2d.b2CrossVV(p,l),this.m_JwB=this.m_ratio*box2d.b2CrossVV(d,l),this.m_mass+=this.m_ratio*this.m_ratio*(this.m_mD+this.m_mB)+this.m_iD*this.m_JwD*this.m_JwD+this.m_iB*this.m_JwB*this.m_JwB);this.m_mass=0<this.m_mass?1/this.m_mass:0;a.step.warmStarting?(b.SelfMulAdd(this.m_mA*this.m_impulse,this.m_JvAC),c+=this.m_iA*this.m_impulse*this.m_JwA,e.SelfMulAdd(this.m_mB*this.m_impulse,this.m_JvBD),f+=this.m_iB*this.m_impulse*this.m_JwB,h.SelfMulSub(this.m_mC*this.m_impulse,this.m_JvAC),k-=this.m_iC*this.m_impulse*
this.m_JwC,m.SelfMulSub(this.m_mD*this.m_impulse,this.m_JvBD),n-=this.m_iD*this.m_impulse*this.m_JwD):this.m_impulse=0;a.velocities[this.m_indexA].w=c;a.velocities[this.m_indexB].w=f;a.velocities[this.m_indexC].w=k;a.velocities[this.m_indexD].w=n};box2d.b2GearJoint.prototype.InitVelocityConstraints.s_u=new box2d.b2Vec2;box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rA=new box2d.b2Vec2;box2d.b2GearJoint.prototype.InitVelocityConstraints.s_rB=new box2d.b2Vec2;
...
e=a.positions[this.m_indexB].a,f=a.velocities[this.m_indexB].v,g=a.velocities[this.m_indexB].w,h=this.m_qA.SetAngleRadians(b),k=this.m_qB.SetAngleRadians(e);box2d.b2SubVV(this.m_localAnchorA,this.m_localCenterA,this.m_lalcA);box2d.b2MulRV(h,this.m_lalcA,this.m_rA);box2d.b2SubVV(this.m_localAnchorB,this.m_localCenterB,this.m_lalcB);box2d.b2MulRV(k,this.m_lalcB,this.m_rB);var h=this.m_invMassA,k=this.m_invMassB,l=this.m_invIA,m=this.m_invIB,n=this.m_K;n.ex.x=h+k+this.m_rA.y*this.m_rA.y*l+this.m_rB.y*
...
var p=box2d.b2MulRV(g,this.m_lalcB,this.m_rB),q=this.m_K;q.ex.x=h+k+n.y*n.y*l+p.y*p.y*m;q.ey.x=-n.y*n.x*l-p.y*p.x*m;q.ez.x=-n.y*l-p.y*m;q.ex.y=q.ey.x;q.ey.y=h+k+n.x*n.x*l+p.x*p.x*m;q.ez.y=n.x*l+p.x*m;q.ex.z=q.ez.x;q.ey.z=q.ez.y;q.ez.z=l+m;if(0<this.m_frequencyHz){var r=box2d.b2SubVV(box2d.b2AddVV(d,p,box2d.b2Vec2.s_t0),box2d.b2AddVV(b,n,box2d.b2Vec2.s_t1),box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_C1);g=r.GetLength();f=0;r=q.Solve22(r.x,r.y,box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_P).SelfNeg();
b.SelfMulSub(h,r);c-=l*box2d.b2CrossVV(n,r);d.SelfMulAdd(k,r);e+=m*box2d.b2CrossVV(p,r)}else r=box2d.b2SubVV(box2d.b2AddVV(d,p,box2d.b2Vec2.s_t0),box2d.b2AddVV(b,n,box2d.b2Vec2.s_t1),box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_C1),n=e-c-this.m_referenceAngle,g=r.GetLength(),f=box2d.b2Abs(n),n=q.Solve33(r.x,r.y,n,box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_impulse).SelfNeg(),r=box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_P.SetXY(n.x,n.y),b.SelfMulSub(h,r),c-=l*(box2d.b2CrossVV(this.m_rA,
r)+n.z),d.SelfMulAdd(k,r),e+=m*(box2d.b2CrossVV(this.m_rB,r)+n.z);a.positions[this.m_indexA].a=c;a.positions[this.m_indexB].a=e;return g<=box2d.b2_linearSlop&&f<=box2d.b2_angularSlop};box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_C1=new box2d.b2Vec2;box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_P=new box2d.b2Vec2;box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_impulse=new box2d.b2Vec3;
...
box2d.b2GravityController.prototype.Step=function(a){if(this.invSqr)for(var b=this.m_bodyList;b;b=b.nextBody){var c=b.body;var d=c.GetWorldCenter();var e=c.GetMass();for(var f=this.m_bodyList;f!==b;f=f.nextBody){var g=f.body;var h=g.GetWorldCenter();var k=g.GetMass();var l=h.x-d.x;var m=h.y-d.y;a=l*l+m*m;a<box2d.b2_epsilon||(m=box2d.b2GravityController.prototype.Step.s_f.SetXY(l,m),m.SelfMul(this.G/a/box2d.b2Sqrt(a)*e*k),c.IsAwake()&&c.ApplyForce(m,d),g.IsAwake()&&g.ApplyForce(m.SelfMul(-1),h))}}else for(b=
this.m_bodyList;b;b=b.nextBody)for(c=b.body,d=c.GetWorldCenter(),e=c.GetMass(),f=this.m_bodyList;f!==b;f=f.nextBody)g=f.body,h=g.GetWorldCenter(),k=g.GetMass(),l=h.x-d.x,m=h.y-d.y,a=l*l+m*m,a<box2d.b2_epsilon||(m=box2d.b2GravityController.prototype.Step.s_f.SetXY(l,m),m.SelfMul(this.G/a*e*k),c.IsAwake()&&c.ApplyForce(m,d),g.IsAwake()&&g.ApplyForce(m.SelfMul(-1),h))};box2d.b2GravityController.prototype.Step.s_f=new box2d.b2Vec2;box2d.b2Profile=function(){};box2d.b2Profile.prototype.step=0;
box2d.b2Profile.prototype.collide=0;box2d.b2Profile.prototype.solve=0;box2d.b2Profile.prototype.solveInit=0;box2d.b2Profile.prototype.solveVelocity=0;box2d.b2Profile.prototype.solvePosition=0;box2d.b2Profile.prototype.broadphase=0;box2d.b2Profile.prototype.solveTOI=0;box2d.b2Profile.prototype.Reset=function(){this.solveTOI=this.broadphase=this.solvePosition=this.solveVelocity=this.solveInit=this.solve=this.collide=this.step=0;return this};box2d.b2TimeStep=function(){};
box2d.b2TimeStep.prototype.dt=0;box2d.b2TimeStep.prototype.inv_dt=0;box2d.b2TimeStep.prototype.dtRatio=0;box2d.b2TimeStep.prototype.velocityIterations=0;box2d.b2TimeStep.prototype.positionIterations=0;box2d.b2TimeStep.prototype.warmStarting=!1;box2d.b2TimeStep.prototype.Copy=function(a){this.dt=a.dt;this.inv_dt=a.inv_dt;this.dtRatio=a.dtRatio;this.positionIterations=a.positionIterations;this.velocityIterations=a.velocityIterations;this.warmStarting=a.warmStarting;return this};
...
var g=box2d.b2SubVMulSV(a,e,this.normal,box2d.b2WorldManifold.prototype.Initialize.s_cB);box2d.b2MidVV(f,g,this.points[0]);this.separations[0]=box2d.b2DotVV(box2d.b2SubVV(g,f,box2d.b2Vec2.s_t0),this.normal);break;case box2d.b2ManifoldType.e_faceA:box2d.b2MulRV(b.q,a.localNormal,this.normal);var h=box2d.b2MulXV(b,a.localPoint,box2d.b2WorldManifold.prototype.Initialize.s_planePoint);for(var k=0,l=a.pointCount;k<l;++k){var m=box2d.b2MulXV(d,a.points[k].localPoint,box2d.b2WorldManifold.prototype.Initialize.s_clipPoint);
...
box2d.b2GetPointStates=function(a,b,c,d){for(var e,f=0,g=c.pointCount;f<g;++f){e=c.points[f].id;e=e.key;a[f]=box2d.b2PointState.b2_removeState;for(var h=0,k=d.pointCount;h<k;++h)if(d.points[h].id.key===e){a[f]=box2d.b2PointState.b2_persistState;break}}for(g=box2d.b2_maxManifoldPoints;f<g;++f)a[f]=box2d.b2PointState.b2_nullState;f=0;for(g=d.pointCount;f<g;++f)for(e=d.points[f].id,e=e.key,b[f]=box2d.b2PointState.b2_addState,h=0,k=c.pointCount;h<k;++h)if(c.points[h].id.key===e){b[f]=box2d.b2PointState.b2_persistState;
break}for(g=box2d.b2_maxManifoldPoints;f<g;++f)b[f]=box2d.b2PointState.b2_nullState};box2d.b2ClipVertex=function(){this.v=new box2d.b2Vec2;this.id=new box2d.b2ContactID};box2d.b2ClipVertex.prototype.v=null;box2d.b2ClipVertex.prototype.id=null;box2d.b2ClipVertex.MakeArray=function(a){return box2d.b2MakeArray(a,function(a){return new box2d.b2ClipVertex})};box2d.b2ClipVertex.prototype.Copy=function(a){this.v.Copy(a.v);this.id.Copy(a.id);return this};
...
box2d.b2AABB.prototype.RayCast=function(a,b){var c=-box2d.b2_maxFloat,d=box2d.b2_maxFloat;var e=b.p1.x;var f=b.p1.y;var g=b.p2.x-b.p1.x;var h=b.p2.y-b.p1.y;var k=box2d.b2Abs(g);var l=box2d.b2Abs(h),m=a.normal;if(k<box2d.b2_epsilon){if(e<this.lowerBound.x||this.upperBound.x<e)return!1}else if(k=1/g,g=(this.lowerBound.x-e)*k,e=(this.upperBound.x-e)*k,k=-1,g>e&&(k=g,g=e,e=k,k=1),g>c&&(m.x=k,m.y=0,c=g),d=box2d.b2Min(d,e),c>d)return!1;if(l<box2d.b2_epsilon){if(f<this.lowerBound.y||this.upperBound.y<f)return!1}else if(k=
1/h,g=(this.lowerBound.y-f)*k,e=(this.upperBound.y-f)*k,k=-1,g>e&&(k=g,g=e,e=k,k=1),g>c&&(m.x=0,m.y=k,c=g),d=box2d.b2Min(d,e),c>d)return!1;if(0>c||b.maxFraction<c)return!1;a.fraction=c;return!0};box2d.b2AABB.prototype.TestOverlap=function(a){var b=a.lowerBound.y-this.upperBound.y,c=this.lowerBound.y-a.upperBound.y;return 0<a.lowerBound.x-this.upperBound.x||0<b||0<this.lowerBound.x-a.upperBound.x||0<c?!1:!0};
...
box2d.b2SeparationFunction.prototype.FindMinSeparation=function(a,b,c){var d=box2d.b2TimeOfImpact.s_xfA;var e=box2d.b2TimeOfImpact.s_xfB;this.m_sweepA.GetTransform(d,c);this.m_sweepB.GetTransform(e,c);switch(this.m_type){case box2d.b2SeparationFunctionType.e_points:var f=box2d.b2MulTRV(d.q,this.m_axis,box2d.b2TimeOfImpact.s_axisA);var g=box2d.b2MulTRV(e.q,box2d.b2NegV(this.m_axis,box2d.b2Vec2.s_t0),box2d.b2TimeOfImpact.s_axisB);a[0]=this.m_proxyA.GetSupport(f);b[0]=this.m_proxyB.GetSupport(g);a=this.m_proxyA.GetVertex(a[0]);
...
box2d.b2SeparationFunction.prototype.Evaluate=function(a,b,c){var d=box2d.b2TimeOfImpact.s_xfA;var e=box2d.b2TimeOfImpact.s_xfB;this.m_sweepA.GetTransform(d,c);this.m_sweepB.GetTransform(e,c);switch(this.m_type){case box2d.b2SeparationFunctionType.e_points:return a=this.m_proxyA.GetVertex(a),b=this.m_proxyB.GetVertex(b),d=box2d.b2MulXV(d,a,box2d.b2TimeOfImpact.s_pointA),e=box2d.b2MulXV(e,b,box2d.b2TimeOfImpact.s_pointB),c=box2d.b2DotVV(box2d.b2SubVV(e,d,box2d.b2Vec2.s_t0),this.m_axis);case box2d.b2SeparationFunctionType.e_faceA:return c=
...
c=box2d.b2DotVV(box2d.b2SubVV(d,e,box2d.b2Vec2.s_t0),c);default:return box2d.ENABLE_ASSERTS&&box2d.b2Assert(!1),0}};
...
p.count=0;var q=box2d.b2TimeOfImpact.s_distanceInput;q.proxyA=b.proxyA;q.proxyB=b.proxyB;for(q.useRadii=!1;;){b=box2d.b2TimeOfImpact.s_xfA;var r=box2d.b2TimeOfImpact.s_xfB;f.GetTransform(b,m);g.GetTransform(r,m);q.transformA.Copy(b);q.transformB.Copy(r);b=box2d.b2TimeOfImpact.s_distanceOutput;box2d.b2Distance(b,p,q);if(0>=b.distance){a.state=box2d.b2TOIOutputState.e_overlapped;a.t=0;break}if(b.distance<k+l){a.state=box2d.b2TOIOutputState.e_touching;a.t=m;break}b=box2d.b2TimeOfImpact.s_fcn;b.Initialize(p,
d,f,e,g,m);for(var r=!1,t=h,u=0;;){var w=box2d.b2TimeOfImpact.s_indexA,x=box2d.b2TimeOfImpact.s_indexB,z=b.FindMinSeparation(w,x,t);if(z>k+l){a.state=box2d.b2TOIOutputState.e_separated;a.t=h;r=!0;break}if(z>k-l){m=t;break}var A=b.Evaluate(w[0],x[0],m);if(A<k-l){a.state=box2d.b2TOIOutputState.e_failed;a.t=m;r=!0;break}if(A<=k+l){a.state=box2d.b2TOIOutputState.e_touching;a.t=m;r=!0;break}for(var v=0,y=m,E=t;;){var F=v&1?y+(k-A)*(E-y)/(z-A):.5*(y+E);++v;++box2d.b2_toiRootIters;var D=b.Evaluate(w[0],
x[0],F);if(box2d.b2Abs(D-k)<l){t=F;break}D>k?(y=F,A=D):(E=F,z=D);if(50===v)break}box2d.b2_toiMaxRootIters=box2d.b2Max(box2d.b2_toiMaxRootIters,v);++u;if(u===box2d.b2_maxPolygonVertices)break}++n;++box2d.b2_toiIters;if(r)break;if(20===n){a.state=box2d.b2TOIOutputState.e_failed;a.t=m;break}}box2d.b2_toiMaxIters=box2d.b2Max(box2d.b2_toiMaxIters,n);a=c.GetMilliseconds();box2d.b2_toiMaxTime=box2d.b2Max(box2d.b2_toiMaxTime,a);box2d.b2_toiTime+=a};box2d.b2TimeOfImpact.s_timer=new box2d.b2Timer;
...
box2d.b2Contact.prototype.Update=function(a){var b=this.m_oldManifold;this.m_oldManifold=this.m_manifold;this.m_manifold=b;this.m_flags|=box2d.b2ContactFlag.e_enabledFlag;var b=(this.m_flags&box2d.b2ContactFlag.e_touchingFlag)===box2d.b2ContactFlag.e_touchingFlag,c=this.m_fixtureA.IsSensor(),d=this.m_fixtureB.IsSensor(),c=c||d,d=this.m_fixtureA.GetBody(),e=this.m_fixtureB.GetBody();var f=d.GetTransform();var g=e.GetTransform();if(c)d=this.m_fixtureA.GetShape(),e=this.m_fixtureB.GetShape(),f=box2d.b2TestOverlapShape(d,
...
box2d.b2PolygonShape.prototype.Set=function(a,b){void 0===b&&(b=a.length);box2d.ENABLE_ASSERTS&&box2d.b2Assert(3<=b&&b<=box2d.b2_maxPolygonVertices);if(3>b)return this.SetAsBox(1,1);b=box2d.b2Min(b,box2d.b2_maxPolygonVertices);for(var c=box2d.b2PolygonShape.prototype.Set.s_ps,d=0,e=0;e<b;++e){var f=a[e];for(var g=!0,h=0;h<d;++h)if(box2d.b2DistanceSquaredVV(f,c[h])<.5*box2d.b2_linearSlop){g=!1;break}g&&c[d++].Copy(f)}b=d;if(3>b)return box2d.ENABLE_ASSERTS&&box2d.b2Assert(!1),this.SetAsBox(1,1);a=0;
f=c[0].x;for(e=1;e<b;++e)if(h=c[e].x,h>f||h===f&&c[e].y<c[a].y)a=e,f=h;g=box2d.b2PolygonShape.prototype.Set.s_hull;d=0;for(e=a;;){g[d]=e;for(var k=0,h=1;h<b;++h)if(k===e)k=h;else{var l=box2d.b2SubVV(c[k],c[g[d]],box2d.b2PolygonShape.prototype.Set.s_r);f=box2d.b2SubVV(c[h],c[g[d]],box2d.b2PolygonShape.prototype.Set.s_v);var m=box2d.b2CrossVV(l,f);0>m&&(k=h);0===m&&f.GetLengthSquared()>l.GetLengthSquared()&&(k=h)}++d;e=k;if(k===a)break}this.m_count=d;for(e=0;e<d;++e)this.m_vertices[e].Copy(c[g[e]]);
e=0;for(b=d;e<b;++e)c=box2d.b2SubVV(this.m_vertices[(e+1)%b],this.m_vertices[e],box2d.b2Vec2.s_t0),box2d.ENABLE_ASSERTS&&box2d.b2Assert(c.GetLengthSquared()>box2d.b2_epsilon_sq),box2d.b2CrossVOne(c,this.m_normals[e]).SelfNormalize();box2d.b2PolygonShape.ComputeCentroid(this.m_vertices,d,this.m_centroid);return this};box2d.b2PolygonShape.prototype.Set.s_ps=box2d.b2Vec2.MakeArray(box2d.b2_maxPolygonVertices);box2d.b2PolygonShape.prototype.Set.s_hull=box2d.b2MakeNumberArray(box2d.b2_maxPolygonVertices);
...
box2d.b2PolygonShape.prototype.TestPoint=function(a,b){a=box2d.b2MulTXV(a,b,box2d.b2PolygonShape.prototype.TestPoint.s_pLocal);b=0;for(var c=this.m_count;b<c;++b)if(0<box2d.b2DotVV(this.m_normals[b],box2d.b2SubVV(a,this.m_vertices[b],box2d.b2Vec2.s_t0)))return!1;return!0};box2d.b2PolygonShape.prototype.TestPoint.s_pLocal=new box2d.b2Vec2;
box2d.b2PolygonShape.prototype.RayCast=function(a,b,c,d){d=box2d.b2MulTXV(c,b.p1,box2d.b2PolygonShape.prototype.RayCast.s_p1);for(var e=box2d.b2MulTXV(c,b.p2,box2d.b2PolygonShape.prototype.RayCast.s_p2),e=box2d.b2SubVV(e,d,box2d.b2PolygonShape.prototype.RayCast.s_d),f=0,g=b.maxFraction,h=-1,k=0,l=this.m_count;k<l;++k){var m=box2d.b2DotVV(this.m_normals[k],box2d.b2SubVV(this.m_vertices[k],d,box2d.b2Vec2.s_t0)),n=box2d.b2DotVV(this.m_normals[k],e);if(0===n){if(0>m)return!1}else 0>n&&m<f*n?(f=m/n,h=
k):0<n&&m<g*n&&(g=m/n);if(g<f)return!1}box2d.ENABLE_ASSERTS&&box2d.b2Assert(0<=f&&f<=b.maxFraction);return 0<=h?(a.fraction=f,box2d.b2MulRV(c.q,this.m_normals[h],a.normal),!0):!1};box2d.b2PolygonShape.prototype.RayCast.s_p1=new box2d.b2Vec2;box2d.b2PolygonShape.prototype.RayCast.s_p2=new box2d.b2Vec2;box2d.b2PolygonShape.prototype.RayCast.s_d=new box2d.b2Vec2;
...
box2d.b2PolygonShape.prototype.ComputeMass=function(a,b){box2d.ENABLE_ASSERTS&&box2d.b2Assert(3<=this.m_count);for(var c=box2d.b2PolygonShape.prototype.ComputeMass.s_center.SetZero(),d=0,e=0,f=box2d.b2PolygonShape.prototype.ComputeMass.s_s.SetZero(),g=0,h=this.m_count;g<h;++g)f.SelfAdd(this.m_vertices[g]);f.SelfMul(1/this.m_count);for(var k=1/3,g=0,h=this.m_count;g<h;++g){var l=box2d.b2SubVV(this.m_vertices[g],f,box2d.b2PolygonShape.prototype.ComputeMass.s_e1),m=box2d.b2SubVV(this.m_vertices[(g+1)%
h],f,box2d.b2PolygonShape.prototype.ComputeMass.s_e2),n=box2d.b2CrossVV(l,m),p=.5*n,d=d+p;c.SelfAdd(box2d.b2MulSV(p*k,box2d.b2AddVV(l,m,box2d.b2Vec2.s_t0),box2d.b2Vec2.s_t1));var p=l.x,l=l.y,q=m.x,m=m.y,e=e+.25*k*n*(p*p+q*p+q*q+(l*l+m*l+m*m))}a.mass=b*d;box2d.ENABLE_ASSERTS&&box2d.b2Assert(d>box2d.b2_epsilon);c.SelfMul(1/d);box2d.b2AddVV(c,f,a.center);a.I=b*e;a.I+=a.mass*(box2d.b2DotVV(a.center,a.center)-box2d.b2DotVV(c,c))};box2d.b2PolygonShape.prototype.ComputeMass.s_center=new box2d.b2Vec2;
...
box2d.b2EPCollider.prototype.Collide=function(a,b,c,d,e){var f;box2d.b2MulTXX(c,e,this.m_xf);box2d.b2MulXV(this.m_xf,d.m_centroid,this.m_centroidB);this.m_v0.Copy(b.m_vertex0);this.m_v1.Copy(b.m_vertex1);this.m_v2.Copy(b.m_vertex2);this.m_v3.Copy(b.m_vertex3);c=b.m_hasVertex0;b=b.m_hasVertex3;e=box2d.b2SubVV(this.m_v2,this.m_v1,box2d.b2EPCollider.s_edge1);e.Normalize();this.m_normal1.SetXY(e.y,-e.x);var g=box2d.b2DotVV(this.m_normal1,box2d.b2SubVV(this.m_centroidB,this.m_v1,box2d.b2Vec2.s_t0)),h=
f=0,k=!1,l=!1;c&&(f=box2d.b2SubVV(this.m_v1,this.m_v0,box2d.b2EPCollider.s_edge0),f.Normalize(),this.m_normal0.SetXY(f.y,-f.x),k=0<=box2d.b2CrossVV(f,e),f=box2d.b2DotVV(this.m_normal0,box2d.b2SubVV(this.m_centroidB,this.m_v0,box2d.b2Vec2.s_t0)));b&&(h=box2d.b2SubVV(this.m_v3,this.m_v2,box2d.b2EPCollider.s_edge2),h.Normalize(),this.m_normal2.SetXY(h.y,-h.x),l=0<box2d.b2CrossVV(e,h),h=box2d.b2DotVV(this.m_normal2,box2d.b2SubVV(this.m_centroidB,this.m_v2,box2d.b2Vec2.s_t0)));c&&b?k&&l?(this.m_front=
0<=f||0<=g||0<=h)?(this.m_normal.Copy(this.m_normal1),this.m_lowerLimit.Copy(this.m_normal0),this.m_upperLimit.Copy(this.m_normal2)):(this.m_normal.Copy(this.m_normal1).SelfNeg(),this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),this.m_upperLimit.Copy(this.m_normal1).SelfNeg()):k?(this.m_front=0<=f||0<=g&&0<=h)?(this.m_normal.Copy(this.m_normal1),this.m_lowerLimit.Copy(this.m_normal0),this.m_upperLimit.Copy(this.m_normal1)):(this.m_normal.Copy(this.m_normal1).SelfNeg(),this.m_lowerLimit.Copy(this.m_normal2).SelfNeg(),
this.m_upperLimit.Copy(this.m_normal1).SelfNeg()):l?(this.m_front=0<=h||0<=f&&0<=g)?(this.m_normal.Copy(this.m_normal1),this.m_lowerLimit.Copy(this.m_normal1),this.m_upperLimit.Copy(this.m_normal2)):(this.m_normal.Copy(this.m_normal1).SelfNeg(),this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),this.m_upperLimit.Copy(this.m_normal0).SelfNeg()):(this.m_front=0<=f&&0<=g&&0<=h)?(this.m_normal.Copy(this.m_normal1),this.m_lowerLimit.Copy(this.m_normal1),this.m_upperLimit.Copy(this.m_normal1)):(this.m_normal.Copy(this.m_normal1).SelfNeg(),
this.m_lowerLimit.Copy(this.m_normal2).SelfNeg(),this.m_upperLimit.Copy(this.m_normal0).SelfNeg()):c?k?((this.m_front=0<=f||0<=g)?(this.m_normal.Copy(this.m_normal1),this.m_lowerLimit.Copy(this.m_normal0)):(this.m_normal.Copy(this.m_normal1).SelfNeg(),this.m_lowerLimit.Copy(this.m_normal1)),this.m_upperLimit.Copy(this.m_normal1).SelfNeg()):(this.m_front=0<=f&&0<=g)?(this.m_normal.Copy(this.m_normal1),this.m_lowerLimit.Copy(this.m_normal1),this.m_upperLimit.Copy(this.m_normal1).SelfNeg()):(this.m_normal.Copy(this.m_normal1).SelfNeg(),
this.m_lowerLimit.Copy(this.m_normal1),this.m_upperLimit.Copy(this.m_normal0).SelfNeg()):b?l?(this.m_front=0<=g||0<=h)?(this.m_normal.Copy(this.m_normal1),this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),this.m_upperLimit.Copy(this.m_normal2)):(this.m_normal.Copy(this.m_normal1).SelfNeg(),this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),this.m_upperLimit.Copy(this.m_normal1)):((this.m_front=0<=g&&0<=h)?(this.m_normal.Copy(this.m_normal1),this.m_lowerLimit.Copy(this.m_normal1).SelfNeg()):(this.m_normal.Copy(this.m_normal1).SelfNeg(),
this.m_lowerLimit.Copy(this.m_normal2).SelfNeg()),this.m_upperLimit.Copy(this.m_normal1)):(this.m_front=0<=g)?(this.m_normal.Copy(this.m_normal1),this.m_lowerLimit.Copy(this.m_normal1).SelfNeg(),this.m_upperLimit.Copy(this.m_normal1).SelfNeg()):(this.m_normal.Copy(this.m_normal1).SelfNeg(),this.m_lowerLimit.Copy(this.m_normal1),this.m_upperLimit.Copy(this.m_normal1));this.m_polygonB.count=d.m_count;g=0;for(f=d.m_count;g<f;++g)box2d.b2MulXV(this.m_xf,d.m_vertices[g],this.m_polygonB.vertices[g]),box2d.b2MulRV(this.m_xf.q,
d.m_normals[g],this.m_polygonB.normals[g]);this.m_radius=2*box2d.b2_polygonRadius;a.pointCount=0;c=this.ComputeEdgeSeparation(box2d.b2EPCollider.s_edgeAxis);if(!(c.type===box2d.b2EPAxisType.e_unknown||c.separation>this.m_radius||(b=this.ComputePolygonSeparation(box2d.b2EPCollider.s_polygonAxis),b.type!==box2d.b2EPAxisType.e_unknown&&b.separation>this.m_radius))){c=b.type===box2d.b2EPAxisType.e_unknown?c:b.separation>.98*c.separation+.001?b:c;e=box2d.b2EPCollider.s_ie;b=box2d.b2EPCollider.s_rf;if(c.type===
box2d.b2EPAxisType.e_edgeA){a.type=box2d.b2ManifoldType.e_faceA;h=0;k=box2d.b2DotVV(this.m_normal,this.m_polygonB.normals[0]);g=1;for(f=this.m_polygonB.count;g<f;++g)l=box2d.b2DotVV(this.m_normal,this.m_polygonB.normals[g]),l<k&&(k=l,h=g);g=(h+1)%this.m_polygonB.count;f=e[0];f.v.Copy(this.m_polygonB.vertices[h]);f.id.cf.indexA=0;f.id.cf.indexB=h;f.id.cf.typeA=box2d.b2ContactFeatureType.e_face;f.id.cf.typeB=box2d.b2ContactFeatureType.e_vertex;f=e[1];f.v.Copy(this.m_polygonB.vertices[g]);f.id.cf.indexA=
0;f.id.cf.indexB=g;f.id.cf.typeA=box2d.b2ContactFeatureType.e_face;f.id.cf.typeB=box2d.b2ContactFeatureType.e_vertex;this.m_front?(b.i1=0,b.i2=1,b.v1.Copy(this.m_v1),b.v2.Copy(this.m_v2),b.normal.Copy(this.m_normal1)):(b.i1=1,b.i2=0,b.v1.Copy(this.m_v2),b.v2.Copy(this.m_v1),b.normal.Copy(this.m_normal1).SelfNeg())}else a.type=box2d.b2ManifoldType.e_faceB,f=e[0],f.v.Copy(this.m_v1),f.id.cf.indexA=0,f.id.cf.indexB=c.index,f.id.cf.typeA=box2d.b2ContactFeatureType.e_vertex,f.id.cf.typeB=box2d.b2ContactFeatureType.e_face,
f=e[1],f.v.Copy(this.m_v2),f.id.cf.indexA=0,f.id.cf.indexB=c.index,f.id.cf.typeA=box2d.b2ContactFeatureType.e_vertex,f.id.cf.typeB=box2d.b2ContactFeatureType.e_face,b.i1=c.index,b.i2=(b.i1+1)%this.m_polygonB.count,b.v1.Copy(this.m_polygonB.vertices[b.i1]),b.v2.Copy(this.m_polygonB.vertices[b.i2]),b.normal.Copy(this.m_polygonB.normals[b.i1]);b.sideNormal1.SetXY(b.normal.y,-b.normal.x);b.sideNormal2.Copy(b.sideNormal1).SelfNeg();b.sideOffset1=box2d.b2DotVV(b.sideNormal1,b.v1);b.sideOffset2=box2d.b2DotVV(b.sideNormal2,
b.v2);g=box2d.b2EPCollider.s_clipPoints1;h=box2d.b2EPCollider.s_clipPoints2;e=box2d.b2ClipSegmentToLine(g,e,b.sideNormal1,b.sideOffset1,b.i1);if(!(e<box2d.b2_maxManifoldPoints||(e=box2d.b2ClipSegmentToLine(h,g,b.sideNormal2,b.sideOffset2,b.i2),e<box2d.b2_maxManifoldPoints))){c.type===box2d.b2EPAxisType.e_edgeA?(a.localNormal.Copy(b.normal),a.localPoint.Copy(b.v1)):(a.localNormal.Copy(d.m_normals[b.i1]),a.localPoint.Copy(d.m_vertices[b.i1]));g=d=0;for(f=box2d.b2_maxManifoldPoints;g<f;++g)box2d.b2DotVV(b.normal,
box2d.b2SubVV(h[g].v,b.v1,box2d.b2Vec2.s_t0))<=this.m_radius&&(e=a.points[d],c.type===box2d.b2EPAxisType.e_edgeA?(box2d.b2MulTXV(this.m_xf,h[g].v,e.localPoint),e.id=h[g].id):(e.localPoint.Copy(h[g].v),e.id.cf.typeA=h[g].id.cf.typeB,e.id.cf.typeB=h[g].id.cf.typeA,e.id.cf.indexA=h[g].id.cf.indexB,e.id.cf.indexB=h[g].id.cf.indexA),++d);a.pointCount=d}}};box2d.b2EPCollider.s_edge1=new box2d.b2Vec2;box2d.b2EPCollider.s_edge0=new box2d.b2Vec2;box2d.b2EPCollider.s_edge2=new box2d.b2Vec2;
...
box2d.b2CollidePolygons.s_planePoint=new box2d.b2Vec2;box2d.b2CollidePolygons.s_normal=new box2d.b2Vec2;box2d.b2CollidePolygons.s_tangent=new box2d.b2Vec2;box2d.b2CollidePolygons.s_ntangent=new box2d.b2Vec2;box2d.b2CollidePolygons.s_v11=new box2d.b2Vec2;box2d.b2CollidePolygons.s_v12=new box2d.b2Vec2;box2d.b2PolygonContact=function(){box2d.b2Contact.call(this)};goog.inherits(box2d.b2PolygonContact,box2d.b2Contact);box2d.b2PolygonContact.Create=function(a){return new box2d.b2PolygonContact};
box2d.b2PolygonContact.Destroy=function(a,b){};box2d.b2PolygonContact.prototype.Reset=function(a,b,c,d){box2d.b2PolygonContact.superClass_.Reset.call(this,a,b,c,d)};
...
var n=f.indexB;var p=f.invMassA;var q=f.invMassB;var r=f.invIA;var t=f.invIB;var u=g.localCenterA;var w=g.localCenterB;g=this.m_positions[m].c;var x=this.m_positions[m].a;var z=this.m_velocities[m].v;m=this.m_velocities[m].w;var A=this.m_positions[n].c;var v=this.m_positions[n].a;var y=this.m_velocities[n].v;n=this.m_velocities[n].w;box2d.ENABLE_ASSERTS&&box2d.b2Assert(0<l.pointCount);b.q.SetAngleRadians(x);c.q.SetAngleRadians(v);box2d.b2SubVV(g,box2d.b2MulRV(b.q,u,box2d.b2Vec2.s_t0),b.p);box2d.b2SubVV(A,
box2d.b2MulRV(c.q,w,box2d.b2Vec2.s_t0),c.p);d.Initialize(l,b,h,c,k);f.normal.Copy(d.normal);box2d.b2CrossVOne(f.normal,f.tangent);k=f.pointCount;for(h=0;h<k;++h)l=f.points[h],box2d.b2SubVV(d.points[h],g,l.rA),box2d.b2SubVV(d.points[h],A,l.rB),u=box2d.b2CrossVV(l.rA,f.normal),w=box2d.b2CrossVV(l.rB,f.normal),u=p+q+r*u*u+t*w*w,l.normalMass=0<u?1/u:0,w=f.tangent,u=box2d.b2CrossVV(l.rA,w),w=box2d.b2CrossVV(l.rB,w),u=p+q+r*u*u+t*w*w,l.tangentMass=0<u?1/u:0,l.velocityBias=0,u=box2d.b2DotVV(f.normal,box2d.b2SubVV(box2d.b2AddVCrossSV(y,
n,l.rB,box2d.b2Vec2.s_t0),box2d.b2AddVCrossSV(z,m,l.rA,box2d.b2Vec2.s_t1),box2d.b2Vec2.s_t0)),u<-box2d.b2_velocityThreshold&&(l.velocityBias+=-f.restitution*u);2===f.pointCount&&(z=f.points[0],A=f.points[1],g=box2d.b2CrossVV(z.rA,f.normal),z=box2d.b2CrossVV(z.rB,f.normal),m=box2d.b2CrossVV(A.rA,f.normal),n=box2d.b2CrossVV(A.rB,f.normal),A=p+q+r*g*g+t*z*z,y=p+q+r*m*m+t*n*n,p=p+q+r*g*m+t*z*n,A*A<1E3*(A*y-p*p)?(f.K.ex.SetXY(A,p),f.K.ey.SetXY(p,y),f.K.GetInverse(f.normalMass)):f.pointCount=1)}};
...
l=box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_d,m=box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P1,n=box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P2,p=box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P1P2;var q=0;for(a=this.m_count;q<a;++q){var r=this.m_velocityConstraints[q];var t=r.indexA;var u=r.indexB;var w=r.invMassA;var x=r.invIA;var z=r.invMassB;var A=r.invIB;var v=r.pointCount;var y=this.m_velocities[t].v;var E=this.m_velocities[t].w;var F=
this.m_velocities[u].v;var D=this.m_velocities[u].w;var B=r.normal;var C=r.tangent;var H=r.friction;box2d.ENABLE_ASSERTS&&box2d.b2Assert(1===v||2===v);var G=0;for(b=v;G<b;++G){v=r.points[G];box2d.b2SubVV(box2d.b2AddVCrossSV(F,D,v.rB,box2d.b2Vec2.s_t0),box2d.b2AddVCrossSV(y,E,v.rA,box2d.b2Vec2.s_t1),c);var I=box2d.b2DotVV(c,C)-r.tangentSpeed;I=v.tangentMass*-I;var J=H*v.normalImpulse;J=box2d.b2Clamp(v.tangentImpulse+I,-J,J);I=J-v.tangentImpulse;v.tangentImpulse=J;box2d.b2MulSV(I,C,f);y.SelfMulSub(w,
f);E-=x*box2d.b2CrossVV(v.rA,f);F.SelfMulAdd(z,f);D+=A*box2d.b2CrossVV(v.rB,f)}if(1===r.pointCount)v=r.points[0],box2d.b2SubVV(box2d.b2AddVCrossSV(F,D,v.rB,box2d.b2Vec2.s_t0),box2d.b2AddVCrossSV(y,E,v.rA,box2d.b2Vec2.s_t1),c),r=box2d.b2DotVV(c,B),I=-v.normalMass*(r-v.velocityBias),J=box2d.b2Max(v.normalImpulse+I,0),I=J-v.normalImpulse,v.normalImpulse=J,box2d.b2MulSV(I,B,f),y.SelfMulSub(w,f),E-=x*box2d.b2CrossVV(v.rA,f),F.SelfMulAdd(z,f),D+=A*box2d.b2CrossVV(v.rB,f);else for(G=r.points[0],C=r.points[1],
g.SetXY(G.normalImpulse,C.normalImpulse),box2d.ENABLE_ASSERTS&&box2d.b2Assert(0<=g.x&&0<=g.y),box2d.b2SubVV(box2d.b2AddVCrossSV(F,D,G.rB,box2d.b2Vec2.s_t0),box2d.b2AddVCrossSV(y,E,G.rA,box2d.b2Vec2.s_t1),d),box2d.b2SubVV(box2d.b2AddVCrossSV(F,D,C.rB,box2d.b2Vec2.s_t0),box2d.b2AddVCrossSV(y,E,C.rA,box2d.b2Vec2.s_t1),e),H=box2d.b2DotVV(d,B),v=box2d.b2DotVV(e,B),h.x=H-G.velocityBias,h.y=v-C.velocityBias,h.SelfSub(box2d.b2MulMV(r.K,g,box2d.b2Vec2.s_t0));;){box2d.b2MulMV(r.normalMass,h,k).SelfNeg();if(0<=
k.x&&0<=k.y){box2d.b2SubVV(k,g,l);box2d.b2MulSV(l.x,B,m);box2d.b2MulSV(l.y,B,n);box2d.b2AddVV(m,n,p);y.SelfMulSub(w,p);E-=x*(box2d.b2CrossVV(G.rA,m)+box2d.b2CrossVV(C.rA,n));F.SelfMulAdd(z,p);D+=A*(box2d.b2CrossVV(G.rB,m)+box2d.b2CrossVV(C.rB,n));G.normalImpulse=k.x;C.normalImpulse=k.y;break}k.x=-G.normalMass*h.x;k.y=0;v=r.K.ex.y*k.x+h.y;if(0<=k.x&&0<=v){box2d.b2SubVV(k,g,l);box2d.b2MulSV(l.x,B,m);box2d.b2MulSV(l.y,B,n);box2d.b2AddVV(m,n,p);y.SelfMulSub(w,p);E-=x*(box2d.b2CrossVV(G.rA,m)+box2d.b2CrossVV(C.rA,
n));F.SelfMulAdd(z,p);D+=A*(box2d.b2CrossVV(G.rB,m)+box2d.b2CrossVV(C.rB,n));G.normalImpulse=k.x;C.normalImpulse=k.y;break}k.x=0;k.y=-C.normalMass*h.y;H=r.K.ey.x*k.y+h.x;if(0<=k.y&&0<=H){box2d.b2SubVV(k,g,l);box2d.b2MulSV(l.x,B,m);box2d.b2MulSV(l.y,B,n);box2d.b2AddVV(m,n,p);y.SelfMulSub(w,p);E-=x*(box2d.b2CrossVV(G.rA,m)+box2d.b2CrossVV(C.rA,n));F.SelfMulAdd(z,p);D+=A*(box2d.b2CrossVV(G.rB,m)+box2d.b2CrossVV(C.rB,n));G.normalImpulse=k.x;C.normalImpulse=k.y;break}k.x=0;k.y=0;H=h.x;v=h.y;if(0<=H&&0<=
v){box2d.b2SubVV(k,g,l);box2d.b2MulSV(l.x,B,m);box2d.b2MulSV(l.y,B,n);box2d.b2AddVV(m,n,p);y.SelfMulSub(w,p);E-=x*(box2d.b2CrossVV(G.rA,m)+box2d.b2CrossVV(C.rA,n));F.SelfMulAdd(z,p);D+=A*(box2d.b2CrossVV(G.rB,m)+box2d.b2CrossVV(C.rB,n));G.normalImpulse=k.x;C.normalImpulse=k.y;break}break}this.m_velocities[t].w=E;this.m_velocities[u].w=D}};box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv=new box2d.b2Vec2;box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv1=new box2d.b2Vec2;
...
this.m_positionConstraints[l];var n=m.indexA;var p=m.indexB;var q=m.localCenterA;var r=m.invMassA;var t=m.invIA;var u=m.localCenterB;var w=m.invMassB;var x=m.invIB;var z=m.pointCount;var A=this.m_positions[n].c;var v=this.m_positions[n].a;var y=this.m_positions[p].c;var E=this.m_positions[p].a;for(b=0;b<z;++b){c.q.SetAngleRadians(v);d.q.SetAngleRadians(E);box2d.b2SubVV(A,box2d.b2MulRV(c.q,q,box2d.b2Vec2.s_t0),c.p);box2d.b2SubVV(y,box2d.b2MulRV(d.q,u,box2d.b2Vec2.s_t0),d.p);e.Initialize(m,c,d,b);var F=
e.normal;var D=e.point;var B=e.separation;box2d.b2SubVV(D,A,f);box2d.b2SubVV(D,y,g);k=box2d.b2Min(k,B);D=box2d.b2Clamp(box2d.b2_baumgarte*(B+box2d.b2_linearSlop),-box2d.b2_maxLinearCorrection,0);B=box2d.b2CrossVV(f,F);var C=box2d.b2CrossVV(g,F);B=r+w+t*B*B+x*C*C;D=0<B?-D/B:0;box2d.b2MulSV(D,F,h);A.SelfMulSub(r,h);v-=t*box2d.b2CrossVV(f,h);y.SelfMulAdd(w,h);E+=x*box2d.b2CrossVV(g,h)}this.m_positions[n].a=v;this.m_positions[p].a=E}return k>-3*box2d.b2_linearSlop};
...
for(c=this.m_count;q<c;++q){var r=this.m_positionConstraints[q];var t=r.indexA;var u=r.indexB;var w=r.localCenterA;var x=r.localCenterB;var z=r.pointCount;var A=e=0;if(t===a||t===b)e=r.invMassA,A=r.invIA;var v=f=0;if(u===a||u===b)f=r.invMassB,v=r.invIB;var y=this.m_positions[t].c;var E=this.m_positions[t].a;var F=this.m_positions[u].c;var D=this.m_positions[u].a;for(d=0;d<z;++d){g.q.SetAngleRadians(E);h.q.SetAngleRadians(D);box2d.b2SubVV(y,box2d.b2MulRV(g.q,w,box2d.b2Vec2.s_t0),g.p);box2d.b2SubVV(F,
box2d.b2MulRV(h.q,x,box2d.b2Vec2.s_t0),h.p);k.Initialize(r,g,h,d);var B=k.normal;var C=k.point;var H=k.separation;box2d.b2SubVV(C,y,l);box2d.b2SubVV(C,F,m);p=box2d.b2Min(p,H);C=box2d.b2Clamp(box2d.b2_toiBaumgarte*(H+box2d.b2_linearSlop),-box2d.b2_maxLinearCorrection,0);H=box2d.b2CrossVV(l,B);var G=box2d.b2CrossVV(m,B);H=e+f+A*H*H+v*G*G;C=0<H?-C/H:0;box2d.b2MulSV(C,B,n);y.SelfMulSub(e,n);E-=A*box2d.b2CrossVV(l,n);F.SelfMulAdd(f,n);D+=v*box2d.b2CrossVV(m,n)}this.m_positions[t].a=E;this.m_positions[u].a=
...
box2d.b2Island.prototype.Solve=function(a,b,c,d){for(var e,f,g,h,k,l,m=box2d.b2Island.s_timer.Reset(),n=b.dt,p=0;p<this.m_bodyCount;++p)e=this.m_bodies[p],this.m_positions[p].c.Copy(e.m_sweep.c),k=e.m_sweep.a,h=this.m_velocities[p].v.Copy(e.m_linearVelocity),g=e.m_angularVelocity,e.m_sweep.c0.Copy(e.m_sweep.c),e.m_sweep.a0=e.m_sweep.a,e.m_type===box2d.b2BodyType.b2_dynamicBody&&(h.x+=n*(e.m_gravityScale*c.x+e.m_invMass*e.m_force.x),h.y+=n*(e.m_gravityScale*c.y+e.m_invMass*e.m_force.y),g+=n*e.m_invI*
e.m_torque,h.SelfMul(1/(1+n*e.m_linearDamping)),g*=1/(1+n*e.m_angularDamping)),this.m_positions[p].a=k,this.m_velocities[p].w=g;m.Reset();e=box2d.b2Island.s_solverData;e.step.Copy(b);e.positions=this.m_positions;e.velocities=this.m_velocities;p=box2d.b2Island.s_contactSolverDef;p.step.Copy(b);p.contacts=this.m_contacts;p.count=this.m_contactCount;p.positions=this.m_positions;p.velocities=this.m_velocities;p.allocator=this.m_allocator;c=box2d.b2Island.s_contactSolver.Initialize(p);c.InitializeVelocityConstraints();
b.warmStarting&&c.WarmStart();for(p=0;p<this.m_jointCount;++p)this.m_joints[p].InitVelocityConstraints(e);a.solveInit=m.GetMilliseconds();m.Reset();for(p=0;p<b.velocityIterations;++p){for(h=0;h<this.m_jointCount;++h)this.m_joints[h].SolveVelocityConstraints(e);c.SolveVelocityConstraints()}c.StoreImpulses();a.solveVelocity=m.GetMilliseconds();for(p=0;p<this.m_bodyCount;++p)l=this.m_positions[p].c,k=this.m_positions[p].a,h=this.m_velocities[p].v,g=this.m_velocities[p].w,f=box2d.b2MulSV(n,h,box2d.b2Island.s_translation),
box2d.b2DotVV(f,f)>box2d.b2_maxTranslationSquared&&(f=box2d.b2_maxTranslation/f.GetLength(),h.SelfMul(f)),f=n*g,f*f>box2d.b2_maxRotationSquared&&(f=box2d.b2_maxRotation/box2d.b2Abs(f),g*=f),l.x+=n*h.x,l.y+=n*h.y,k+=n*g,this.m_positions[p].a=k,this.m_velocities[p].w=g;m.Reset();g=!1;for(p=0;p<b.positionIterations;++p){k=c.SolvePositionConstraints();l=!0;for(h=0;h<this.m_jointCount;++h)f=this.m_joints[h].SolvePositionConstraints(e),l=l&&f;if(k&&l){g=!0;break}}for(p=0;p<this.m_bodyCount;++p)b=this.m_bodies[p],
b.m_sweep.c.Copy(this.m_positions[p].c),b.m_sweep.a=this.m_positions[p].a,b.m_linearVelocity.Copy(this.m_velocities[p].v),b.m_angularVelocity=this.m_velocities[p].w,b.SynchronizeTransform();a.solvePosition=m.GetMilliseconds();this.Report(c.m_velocityConstraints);if(d){a=box2d.b2_maxFloat;d=box2d.b2_linearSleepTolerance*box2d.b2_linearSleepTolerance;m=box2d.b2_angularSleepTolerance*box2d.b2_angularSleepTolerance;for(p=0;p<this.m_bodyCount;++p)e=this.m_bodies[p],e.GetType()!==box2d.b2BodyType.b2_staticBody&&
(0===(e.m_flags&box2d.b2BodyFlag.e_autoSleepFlag)||e.m_angularVelocity*e.m_angularVelocity>m||box2d.b2DotVV(e.m_linearVelocity,e.m_linearVelocity)>d?a=e.m_sleepTime=0:(e.m_sleepTime+=n,a=box2d.b2Min(a,e.m_sleepTime)));if(a>=box2d.b2_timeToSleep&&g)for(p=0;p<this.m_bodyCount;++p)e=this.m_bodies[p],e.SetAwake(!1)}};
...
box2d.b2BroadPhase.prototype.m_tree=null;box2d.b2BroadPhase.prototype.m_proxyCount=0;box2d.b2BroadPhase.prototype.m_moveCount=0;box2d.b2BroadPhase.prototype.m_moveBuffer=null;box2d.b2BroadPhase.prototype.m_pairCount=0;box2d.b2BroadPhase.prototype.m_pairBuffer=null;box2d.b2BroadPhase.prototype.CreateProxy=function(a,b){a=this.m_tree.CreateProxy(a,b);++this.m_proxyCount;this.BufferMove(a);return a};box2d.b2BroadPhase.prototype.DestroyProxy=function(a){this.UnBufferMove(a);--this.m_proxyCount;this.m_tree.DestroyProxy(a)};
...
box2d.b2ContactManager.prototype.Collide=function(){for(var a,b=this.m_contactList;b;){a=b.GetFixtureA();var c=b.GetFixtureB(),d=b.GetChildIndexA(),e=b.GetChildIndexB(),f=a.GetBody(),g=c.GetBody();if(b.m_flags&box2d.b2ContactFlag.e_filterFlag){if(!1===g.ShouldCollide(f)){a=b;b=a.m_next;this.Destroy(a);continue}if(this.m_contactFilter&&!1===this.m_contactFilter.ShouldCollide(a,c)){a=b;b=a.m_next;this.Destroy(a);continue}b.m_flags&=~box2d.b2ContactFlag.e_filterFlag}f=f.IsAwake()&&f.m_type!==box2d.b2BodyType.b2_staticBody;
g=g.IsAwake()&&g.m_type!==box2d.b2BodyType.b2_staticBody;!1===f&&!1===g?b=b.m_next:!1===this.m_broadPhase.TestOverlap(a.m_proxies[d].proxy,c.m_proxies[e].proxy)?(a=b,b=a.m_next,this.Destroy(a)):(b.Update(this.m_contactListener),b=b.m_next)}};box2d.b2ContactManager.prototype.FindNewContacts=function(){this.m_broadPhase.UpdatePairs(this)};
box2d.b2ContactManager.prototype.AddPair=function(a,b){box2d.ENABLE_ASSERTS&&box2d.b2Assert(a instanceof box2d.b2FixtureProxy);box2d.ENABLE_ASSERTS&&box2d.b2Assert(b instanceof box2d.b2FixtureProxy);var c=a.fixture,d=b.fixture;a=a.childIndex;var e=b.childIndex;b=c.GetBody();var f=d.GetBody();if(b!==f){for(var g=f.GetContactList();g;){if(g.other===b){var h=g.contact.GetFixtureA(),k=g.contact.GetFixtureB(),l=g.contact.GetChildIndexA(),m=g.contact.GetChildIndexB();if(h===c&&k===d&&l===a&&m===e||h===
d&&k===c&&l===e&&m===a)return}g=g.next}!1===f.ShouldCollide(b)||this.m_contactFilter&&!1===this.m_contactFilter.ShouldCollide(c,d)||(a=this.m_contactFactory.Create(c,a,d,e),null!==a&&(c=a.GetFixtureA(),d=a.GetFixtureB(),a.GetChildIndexA(),a.GetChildIndexB(),b=c.m_body,f=d.m_body,a.m_prev=null,a.m_next=this.m_contactList,null!==this.m_contactList&&(this.m_contactList.m_prev=a),this.m_contactList=a,a.m_nodeA.contact=a,a.m_nodeA.other=f,a.m_nodeA.prev=null,a.m_nodeA.next=b.m_contactList,null!==b.m_contactList&&
(b.m_contactList.prev=a.m_nodeA),b.m_contactList=a.m_nodeA,a.m_nodeB.contact=a,a.m_nodeB.other=b,a.m_nodeB.prev=null,a.m_nodeB.next=f.m_contactList,null!==f.m_contactList&&(f.m_contactList.prev=a.m_nodeB),f.m_contactList=a.m_nodeB,!1===c.IsSensor()&&!1===d.IsSensor()&&(b.SetAwake(!0),f.SetAwake(!0)),++this.m_contactCount))}};box2d.b2JointFactory={};
box2d.b2JointFactory.Create=function(a,b){b=null;switch(a.type){case box2d.b2JointType.e_distanceJoint:b=new box2d.b2DistanceJoint(a instanceof box2d.b2DistanceJointDef?a:null);break;case box2d.b2JointType.e_mouseJoint:b=new box2d.b2MouseJoint(a instanceof box2d.b2MouseJointDef?a:null);break;case box2d.b2JointType.e_prismaticJoint:b=new box2d.b2PrismaticJoint(a instanceof box2d.b2PrismaticJointDef?a:null);break;case box2d.b2JointType.e_revoluteJoint:b=new box2d.b2RevoluteJoint(a instanceof box2d.b2RevoluteJointDef?
...
e=c.GetFixtureB();a!==d&&a!==e||this.m_world.m_contactManager.Destroy(c)}this.m_flags&box2d.b2BodyFlag.e_activeFlag&&a.DestroyProxies(this.m_world.m_contactManager.m_broadPhase);a.Destroy();a.m_body=null;a.m_next=null;--this.m_fixtureCount;this.ResetMassData()}};box2d.b2Body.prototype.SetTransformVecRadians=function(a,b){this.SetTransformXYRadians(a.x,a.y,b)};
...
box2d.b2World.prototype.GetContactCount=function(){return this.m_contactManager.m_contactCount};box2d.b2World.prototype.SetGravity=function(a,b){b=b||!0;if(this.m_gravity.x!==a.x||this.m_gravity.y!==a.y)if(this.m_gravity.Copy(a),b)for(a=this.m_bodyList;a;a=a.m_next)a.SetAwake(!0)};box2d.b2World.prototype.GetGravity=function(a){a=a||this.m_out_gravity;return a.Copy(this.m_gravity)};box2d.b2World.prototype.IsLocked=function(){return 0<(this.m_flags&box2d.b2WorldFlag.e_locked)};
...
box2d.b2World.prototype.Solve=function(a){for(var b,c,d=this.m_controllerList;d;d=d.m_next)d.Step(a);this.m_profile.solveInit=0;this.m_profile.solveVelocity=0;this.m_profile.solvePosition=0;d=this.m_island;d.Initialize(this.m_bodyCount,this.m_contactManager.m_contactCount,this.m_jointCount,null,this.m_contactManager.m_contactListener);for(b=this.m_bodyList;b;b=b.m_next)b.m_flags&=~box2d.b2BodyFlag.e_islandFlag;for(var e=this.m_contactManager.m_contactList;e;e=e.m_next)e.m_flags&=~box2d.b2ContactFlag.e_islandFlag;
for(e=this.m_jointList;e;e=e.m_next)e.m_islandFlag=!1;for(var e=this.m_bodyCount,f=this.s_stack,g=this.m_bodyList;g;g=g.m_next)if(!(g.m_flags&box2d.b2BodyFlag.e_islandFlag)&&!1!==g.IsAwake()&&!1!==g.IsActive()&&g.GetType()!==box2d.b2BodyType.b2_staticBody){d.Clear();var h=0;f[h++]=g;for(g.m_flags|=box2d.b2BodyFlag.e_islandFlag;0<h;)if(b=f[--h],box2d.ENABLE_ASSERTS&&box2d.b2Assert(!0===b.IsActive()),d.AddBody(b),b.SetAwake(!0),b.GetType()!==box2d.b2BodyType.b2_staticBody){for(var k=b.m_contactList;k;k=
k.next)if(c=k.contact,!(c.m_flags&box2d.b2ContactFlag.e_islandFlag)&&!1!==c.IsEnabled()&&!1!==c.IsTouching()){var l=c.m_fixtureB.m_isSensor;c.m_fixtureA.m_isSensor||l||(d.AddContact(c),c.m_flags|=box2d.b2ContactFlag.e_islandFlag,c=k.other,c.m_flags&box2d.b2BodyFlag.e_islandFlag||(box2d.ENABLE_ASSERTS&&box2d.b2Assert(h<e),f[h++]=c,c.m_flags|=box2d.b2BodyFlag.e_islandFlag))}for(b=b.m_jointList;b;b=b.next)!0!==b.joint.m_islandFlag&&(c=b.other,!1!==c.IsActive()&&(d.AddJoint(b.joint),b.joint.m_islandFlag=
!0,c.m_flags&box2d.b2BodyFlag.e_islandFlag||(box2d.ENABLE_ASSERTS&&box2d.b2Assert(h<e),f[h++]=c,c.m_flags|=box2d.b2BodyFlag.e_islandFlag)))}b=new box2d.b2Profile;d.Solve(b,a,this.m_gravity,this.m_allowSleep);this.m_profile.solveInit+=b.solveInit;this.m_profile.solveVelocity+=b.solveVelocity;this.m_profile.solvePosition+=b.solvePosition;for(h=0;h<d.m_bodyCount;++h)b=d.m_bodies[h],b.GetType()===box2d.b2BodyType.b2_staticBody&&(b.m_flags&=~box2d.b2BodyFlag.e_islandFlag)}for(h=0;h<f.length&&f[h];++h)f[h]=
null;a=new box2d.b2Timer;for(b=this.m_bodyList;b;b=b.m_next)0!==(b.m_flags&box2d.b2BodyFlag.e_islandFlag)&&b.GetType()!==box2d.b2BodyType.b2_staticBody&&b.SynchronizeFixtures();this.m_contactManager.FindNewContacts();this.m_profile.broadphase=a.GetMilliseconds()};
...
d.m_next)if(!1!==d.IsEnabled()&&!(d.m_toiCount>box2d.b2_maxSubSteps)){if(d.m_flags&box2d.b2ContactFlag.e_toiFlag)var f=d.m_toi;else{var g=d.GetFixtureA();var h=d.GetFixtureB();if(g.IsSensor()||h.IsSensor())continue;var k=g.GetBody();f=h.GetBody();var l=k.m_type,m=f.m_type;box2d.ENABLE_ASSERTS&&box2d.b2Assert(l===box2d.b2BodyType.b2_dynamicBody||m===box2d.b2BodyType.b2_dynamicBody);var n=k.IsAwake()&&l!==box2d.b2BodyType.b2_staticBody,p=f.IsAwake()&&m!==box2d.b2BodyType.b2_staticBody;if(!1===n&&!1===
p)continue;l=k.IsBullet()||l!==box2d.b2BodyType.b2_dynamicBody;m=f.IsBullet()||m!==box2d.b2BodyType.b2_dynamicBody;if(!1===l&&!1===m)continue;m=k.m_sweep.alpha0;k.m_sweep.alpha0<f.m_sweep.alpha0?(m=f.m_sweep.alpha0,k.m_sweep.Advance(m)):f.m_sweep.alpha0<k.m_sweep.alpha0&&(m=k.m_sweep.alpha0,f.m_sweep.Advance(m));box2d.ENABLE_ASSERTS&&box2d.b2Assert(1>m);n=d.GetChildIndexA();p=d.GetChildIndexB();l=box2d.b2World.prototype.SolveTOI.s_toi_input;l.proxyA.SetShape(g.GetShape(),n);l.proxyB.SetShape(h.GetShape(),
p);l.sweepA.Copy(k.m_sweep);l.sweepB.Copy(f.m_sweep);l.tMax=1;f=box2d.b2World.prototype.SolveTOI.s_toi_output;box2d.b2TimeOfImpact(f,l);k=f.t;f=f.state===box2d.b2TOIOutputState.e_touching?box2d.b2Min(m+(1-m)*k,1):1;d.m_toi=f;d.m_flags|=box2d.b2ContactFlag.e_toiFlag}f<c&&(e=d,c=f)}if(null===e||1-10*box2d.b2_epsilon<c){this.m_stepComplete=!0;break}g=e.GetFixtureA();h=e.GetFixtureB();k=g.GetBody();f=h.GetBody();d=box2d.b2World.prototype.SolveTOI.s_backup1.Copy(k.m_sweep);h=box2d.b2World.prototype.SolveTOI.s_backup2.Copy(f.m_sweep);
k.Advance(c);f.Advance(c);e.Update(this.m_contactManager.m_contactListener);e.m_flags&=~box2d.b2ContactFlag.e_toiFlag;++e.m_toiCount;if(!1===e.IsEnabled()||!1===e.IsTouching())e.SetEnabled(!1),k.m_sweep.Copy(d),f.m_sweep.Copy(h),k.SynchronizeTransform(),f.SynchronizeTransform();else{k.SetAwake(!0);f.SetAwake(!0);b.Clear();b.AddBody(k);b.AddBody(f);b.AddContact(e);k.m_flags|=box2d.b2BodyFlag.e_islandFlag;f.m_flags|=box2d.b2BodyFlag.e_islandFlag;e.m_flags|=box2d.b2ContactFlag.e_islandFlag;for(d=0;2>
d;++d)if(e=0===d?k:f,e.m_type===box2d.b2BodyType.b2_dynamicBody)for(h=e.m_contactList;h&&b.m_bodyCount!==b.m_bodyCapacity&&b.m_contactCount!==b.m_contactCapacity;h=h.next)g=h.contact,g.m_flags&box2d.b2ContactFlag.e_islandFlag||(m=h.other,m.m_type===box2d.b2BodyType.b2_dynamicBody&&!1===e.IsBullet()&&!1===m.IsBullet())||(l=g.m_fixtureB.m_isSensor,g.m_fixtureA.m_isSensor||l||(l=box2d.b2World.prototype.SolveTOI.s_backup.Copy(m.m_sweep),0===(m.m_flags&box2d.b2BodyFlag.e_islandFlag)&&m.Advance(c),g.Update(this.m_contactManager.m_contactListener),
!1===g.IsEnabled()?(m.m_sweep.Copy(l),m.SynchronizeTransform()):!1===g.IsTouching()?(m.m_sweep.Copy(l),m.SynchronizeTransform()):(g.m_flags|=box2d.b2ContactFlag.e_islandFlag,b.AddContact(g),m.m_flags&box2d.b2BodyFlag.e_islandFlag||(m.m_flags|=box2d.b2BodyFlag.e_islandFlag,m.m_type!==box2d.b2BodyType.b2_staticBody&&m.SetAwake(!0),b.AddBody(m)))));e=box2d.b2World.prototype.SolveTOI.s_subStep;e.dt=(1-c)*a.dt;e.inv_dt=1/e.dt;e.dtRatio=1;e.positionIterations=20;e.velocityIterations=a.velocityIterations;
e.warmStarting=!1;b.SolveTOI(e,k.m_islandIndex,f.m_islandIndex);for(d=0;d<b.m_bodyCount;++d)if(e=b.m_bodies[d],e.m_flags&=~box2d.b2BodyFlag.e_islandFlag,e.m_type===box2d.b2BodyType.b2_dynamicBody)for(e.SynchronizeFixtures(),h=e.m_contactList;h;h=h.next)h.contact.m_flags&=~(box2d.b2ContactFlag.e_toiFlag|box2d.b2ContactFlag.e_islandFlag);this.m_contactManager.FindNewContacts();if(this.m_subStepping){this.m_stepComplete=!1;break}}}};box2d.b2World.prototype.SolveTOI.s_subStep=new box2d.b2TimeStep;
...
box2d.b2World.prototype.RayCast=function(a,b,c){var d=this.m_contactManager.m_broadPhase,e=box2d.b2World.prototype.RayCast.s_input;e.maxFraction=1;e.p1.Copy(b);e.p2.Copy(c);d.RayCast(function(e,g){var f=d.GetUserData(g);box2d.ENABLE_ASSERTS&&box2d.b2Assert(f instanceof box2d.b2FixtureProxy);g=f.fixture;var k=box2d.b2World.prototype.RayCast.s_output;return g.RayCast(k,e,f.childIndex)?(e=k.fraction,f=box2d.b2World.prototype.RayCast.s_point,f.SetXY((1-e)*b.x+e*c.x,(1-e)*b.y+e*c.y),a instanceof box2d.b2RayCastCallback?
a.ReportFixture(g,f,k.normal,e):a(g,f,k.normal,e)):e.maxFraction},e)};box2d.b2World.prototype.RayCast.s_input=new box2d.b2RayCastInput;box2d.b2World.prototype.RayCast.s_output=new box2d.b2RayCastOutput;box2d.b2World.prototype.RayCast.s_point=new box2d.b2Vec2;box2d.b2World.prototype.RayCastOne=function(a,b){var c=null,d=1;this.RayCast(function(a,b,g,h){h<d&&(d=h,c=a);return d},a,b);return c};
...
box2d.b2World.prototype.DrawShape=function(a,b){a=a.GetShape();switch(a.m_type){case box2d.b2ShapeType.e_circleShape:a=a instanceof box2d.b2CircleShape?a:null;this.m_debugDraw.DrawSolidCircle(a.m_p,a.m_radius,box2d.b2Vec2.UNITX,b);break;case box2d.b2ShapeType.e_edgeShape:a=a instanceof box2d.b2EdgeShape?a:null;var c=a.m_vertex1;var d=a.m_vertex2;this.m_debugDraw.DrawSegment(c,d,b);break;case box2d.b2ShapeType.e_chainShape:a=a instanceof box2d.b2ChainShape?a:null;var e=a.m_count;a=a.m_vertices;c=a[0];
for(var f=0;f<e;++f)d=a[f],this.m_debugDraw.DrawSegment(c,d,b),this.m_debugDraw.DrawCircle(d,.05,b),c=d;break;case box2d.b2ShapeType.e_polygonShape:a=a instanceof box2d.b2PolygonShape?a:null,c=a.m_count,a=a.m_vertices,this.m_debugDraw.DrawSolidPolygon(a,c,b)}};
...
!1===c.IsAwake()?b.SetRGB(.6,.6,.6):b.SetRGB(.9,.7,.7),this.DrawShape(e,b);this.m_debugDraw.PopTransform(d)}if(a&box2d.b2DrawFlags.e_jointBit)for(c=this.m_jointList;c;c=c.m_next)this.DrawJoint(c);if(a&box2d.b2DrawFlags.e_aabbBit){b.SetRGB(.9,.3,.9);d=this.m_contactManager.m_broadPhase;for(var f=box2d.b2World.prototype.DrawDebugData.s_vs,c=this.m_bodyList;c;c=c.m_next)if(!1!==c.IsActive())for(e=c.GetFixtureList();e;e=e.m_next)for(var g=0;g<e.m_proxyCount;++g){var h=d.GetFatAABB(e.m_proxies[g].proxy);
...
box2d.b2AreaJoint.prototype.InitVelocityConstraints=function(a){for(var b,c=0,d=this.m_bodies.length;c<d;++c){var e=a.positions[this.m_bodies[(c+d-1)%d].m_islandIndex].c,f=a.positions[this.m_bodies[(c+1)%d].m_islandIndex].c;b=this.m_deltas[c];box2d.b2SubVV(f,e,b)}if(a.step.warmStarting)for(this.m_impulse*=a.step.dtRatio,c=0,d=this.m_bodies.length;c<d;++c)e=this.m_bodies[c],f=a.velocities[e.m_islandIndex].v,b=this.m_deltas[c],f.x+=e.m_invMass*b.y*.5*this.m_impulse,f.y+=e.m_invMass*-b.x*.5*this.m_impulse;
else this.m_impulse=0};box2d.b2AreaJoint.prototype.SolveVelocityConstraints=function(a){for(var b,c,d,e=0,f=0,g=0,h=this.m_bodies.length;g<h;++g)d=this.m_bodies[g],c=a.velocities[d.m_islandIndex].v,b=this.m_deltas[g],e+=b.GetLengthSquared()/d.GetMass(),f+=box2d.b2CrossVV(c,b);e=-2*f/e;this.m_impulse+=e;g=0;for(h=this.m_bodies.length;g<h;++g)d=this.m_bodies[g],c=a.velocities[d.m_islandIndex].v,b=this.m_deltas[g],c.x+=d.m_invMass*b.y*.5*e,c.y+=d.m_invMass*-b.x*.5*e};
box2d.b2AreaJoint.prototype.SolvePositionConstraints=function(a){for(var b,c,d=0,e=0,f=0,g=this.m_bodies.length;f<g;++f){c=this.m_bodies[f];b=this.m_bodies[(f+1)%g];c=a.positions[c.m_islandIndex].c;var h=a.positions[b.m_islandIndex].c;b=box2d.b2SubVV(h,c,this.m_delta);var k=b.GetLength();k<box2d.b2_epsilon&&(k=1);this.m_normals[f].x=b.y/k;this.m_normals[f].y=-b.x/k;d+=k;e+=box2d.b2CrossVV(c,h)}d=.5*(this.m_targetArea-.5*e)/d;e=!0;f=0;for(g=this.m_bodies.length;f<g;++f)c=this.m_bodies[f],c=a.positions[c.m_islandIndex].c,
b=box2d.b2AddVV(this.m_normals[f],this.m_normals[(f+1)%g],this.m_delta),b.SelfMul(d),h=b.GetLengthSquared(),h>box2d.b2Sq(box2d.b2_maxLinearCorrection)&&b.SelfMul(box2d.b2_maxLinearCorrection/box2d.b2Sqrt(h)),h>box2d.b2Sq(box2d.b2_linearSlop)&&(e=!1),c.x+=b.x,c.y+=b.y;return e};box2d.b2BuoyancyController=function(){box2d.b2Controller.call(this);this.normal=new box2d.b2Vec2(0,1);this.velocity=new box2d.b2Vec2(0,0);this.gravity=new box2d.b2Vec2(0,0)};goog.inherits(box2d.b2BuoyancyController,box2d.b2Controller);
...
h.y*l}c.x/=e;c.y/=e;d.x/=f;d.y/=f;e<box2d.b2_epsilon||(f=box2d.b2NegV(this.gravity,new box2d.b2Vec2),f.SelfMul(this.density*e),b.ApplyForce(f,d),d=b.GetLinearVelocityFromWorldPoint(c,new box2d.b2Vec2),d.SelfSub(this.velocity),d.SelfMul(-this.linearDrag*e),b.ApplyForce(d,c),b.ApplyTorque(-b.GetInertia()/b.GetMass()*e*b.GetAngularVelocity()*this.angularDrag))}}};
...
e=a.velocities[this.m_indexB].v,f=a.velocities[this.m_indexB].w,g=this.m_qA.SetAngleRadians(a.positions[this.m_indexA].a),d=this.m_qB.SetAngleRadians(d);box2d.b2SubVV(this.m_localAnchorA,this.m_localCenterA,this.m_lalcA);g=box2d.b2MulRV(g,this.m_lalcA,this.m_rA);box2d.b2SubVV(this.m_localAnchorB,this.m_localCenterB,this.m_lalcB);var h=box2d.b2MulRV(d,this.m_lalcB,this.m_rB),d=this.m_invMassA,k=this.m_invMassB,l=this.m_invIA,m=this.m_invIB,n=this.m_K;n.ex.x=d+k+l*g.y*g.y+m*h.y*h.y;n.ex.y=-l*g.x*g.y-
m*h.x*h.y;n.ey.x=n.ex.y;n.ey.y=d+k+l*g.x*g.x+m*h.x*h.x;n.GetInverse(this.m_linearMass);this.m_angularMass=l+m;0<this.m_angularMass&&(this.m_angularMass=1/this.m_angularMass);a.step.warmStarting?(this.m_linearImpulse.SelfMul(a.step.dtRatio),this.m_angularImpulse*=a.step.dtRatio,g=this.m_linearImpulse,b.SelfMulSub(d,g),c-=l*(box2d.b2CrossVV(this.m_rA,g)+this.m_angularImpulse),e.SelfMulAdd(k,g),f+=m*(box2d.b2CrossVV(this.m_rB,g)+this.m_angularImpulse)):(this.m_linearImpulse.SetZero(),this.m_angularImpulse=
...
box2d.b2CircleShape.prototype.Copy=function(a){box2d.b2CircleShape.superClass_.Copy.call(this,a);box2d.ENABLE_ASSERTS&&box2d.b2Assert(a instanceof box2d.b2CircleShape);this.m_p.Copy(a.m_p);return this};box2d.b2CircleShape.prototype.GetChildCount=function(){return 1};box2d.b2CircleShape.prototype.TestPoint=function(a,b){a=box2d.b2MulXV(a,this.m_p,box2d.b2CircleShape.prototype.TestPoint.s_center);b=box2d.b2SubVV(b,a,box2d.b2CircleShape.prototype.TestPoint.s_d);return box2d.b2DotVV(b,b)<=box2d.b2Sq(this.m_radius)};
...
box2d.b2WheelJoint.prototype.SolveVelocityConstraints=function(a){var b=this.m_invMassA,c=this.m_invMassB,d=this.m_invIA,e=this.m_invIB,f=a.velocities[this.m_indexA].v,g=a.velocities[this.m_indexA].w,h=a.velocities[this.m_indexB].v,k=a.velocities[this.m_indexB].w;var l=box2d.b2DotVV(this.m_ax,box2d.b2SubVV(h,f,box2d.b2Vec2.s_t0))+this.m_sBx*k-this.m_sAx*g;l=-this.m_springMass*(l+this.m_bias+this.m_gamma*this.m_springImpulse);this.m_springImpulse+=l;var m=box2d.b2MulSV(l,this.m_ax,box2d.b2WheelJoint.prototype.SolveVelocityConstraints.s_P);
var n=l*this.m_sAx;l*=this.m_sBx;f.SelfMulSub(b,m);g-=d*n;h.SelfMulAdd(c,m);k+=e*l;l=k-g-this.m_motorSpeed;l*=-this.m_motorMass;n=this.m_motorImpulse;m=a.step.dt*this.m_maxMotorTorque;this.m_motorImpulse=box2d.b2Clamp(this.m_motorImpulse+l,-m,m);l=this.m_motorImpulse-n;g-=d*l;k+=e*l;l=box2d.b2DotVV(this.m_ay,box2d.b2SubVV(h,f,box2d.b2Vec2.s_t0))+this.m_sBy*k-this.m_sAy*g;l*=-this.m_mass;this.m_impulse+=l;m=box2d.b2MulSV(l,this.m_ay,box2d.b2WheelJoint.prototype.SolveVelocityConstraints.s_P);n=l*this.m_sAy;
...
b,box2d.b2Vec2.s_t0),box2d.b2SubVV(g,h,box2d.b2Vec2.s_t1),box2d.b2WheelJoint.prototype.SolvePositionConstraints.s_d),f=box2d.b2MulRV(f,this.m_localYAxisA,this.m_ay),h=box2d.b2CrossVV(box2d.b2AddVV(k,h,box2d.b2Vec2.s_t0),f),g=box2d.b2CrossVV(g,f),k=box2d.b2DotVV(k,this.m_ay),l=this.m_invMassA+this.m_invMassB+this.m_invIA*this.m_sAy*this.m_sAy+this.m_invIB*this.m_sBy*this.m_sBy,l=0!==l?-k/l:0,f=box2d.b2MulSV(l,f,box2d.b2WheelJoint.prototype.SolvePositionConstraints.s_P),h=l*h,g=l*g;b.SelfMulSub(this.m_invMassA,
...
box2d.b2MotorJointDef.prototype.Initialize=function(a,b){this.bodyA=a;this.bodyB=b;this.bodyA.GetLocalPoint(this.bodyB.GetPosition(),this.linearOffset);a=this.bodyA.GetAngleRadians();this.angularOffset=this.bodyB.GetAngleRadians()-a};
...
e=a.velocities[this.m_indexA].w,f=a.positions[this.m_indexB].c,g=a.positions[this.m_indexB].a,h=a.velocities[this.m_indexB].v,k=a.velocities[this.m_indexB].w,l=this.m_qA.SetAngleRadians(c),m=this.m_qB.SetAngleRadians(g),n=box2d.b2MulRV(l,box2d.b2NegV(this.m_localCenterA,box2d.b2Vec2.s_t0),this.m_rA),m=box2d.b2MulRV(m,box2d.b2NegV(this.m_localCenterB,box2d.b2Vec2.s_t0),this.m_rB),p=this.m_invMassA,q=this.m_invMassB,r=this.m_invIA,t=this.m_invIB,u=this.m_K;u.ex.x=p+q+r*n.y*n.y+t*m.y*m.y;u.ex.y=-r*n.x*
n.y-t*m.x*m.y;u.ey.x=u.ex.y;u.ey.y=p+q+r*n.x*n.x+t*m.x*m.x;u.GetInverse(this.m_linearMass);this.m_angularMass=r+t;0<this.m_angularMass&&(this.m_angularMass=1/this.m_angularMass);box2d.b2SubVV(box2d.b2SubVV(box2d.b2AddVV(f,m,box2d.b2Vec2.s_t0),box2d.b2AddVV(b,n,box2d.b2Vec2.s_t1),box2d.b2Vec2.s_t2),box2d.b2MulRV(l,this.m_linearOffset,box2d.b2Vec2.s_t3),this.m_linearError);this.m_angularError=g-c-this.m_angularOffset;a.step.warmStarting?(this.m_linearImpulse.SelfMul(a.step.dtRatio),this.m_angularImpulse*=
...
box2d.b2MotorJoint.prototype.SolveVelocityConstraints=function(a){var b=a.velocities[this.m_indexA].v,c=a.velocities[this.m_indexA].w,d=a.velocities[this.m_indexB].v,e=a.velocities[this.m_indexB].w,f=this.m_invMassA,g=this.m_invMassB,h=this.m_invIA,k=this.m_invIB,l=a.step.dt,m=a.step.inv_dt;var n=e-c+m*this.m_correctionFactor*this.m_angularError;var p=-this.m_angularMass*n;var q=this.m_angularImpulse;n=l*this.m_maxTorque;this.m_angularImpulse=box2d.b2Clamp(this.m_angularImpulse+p,-n,n);p=this.m_angularImpulse-
q;var c=c-h*p,e=e+k*p,r=this.m_rA,t=this.m_rB;n=box2d.b2AddVV(box2d.b2SubVV(box2d.b2AddVV(d,box2d.b2CrossSV(e,t,box2d.b2Vec2.s_t0),box2d.b2Vec2.s_t0),box2d.b2AddVV(b,box2d.b2CrossSV(c,r,box2d.b2Vec2.s_t1),box2d.b2Vec2.s_t1),box2d.b2Vec2.s_t2),box2d.b2MulSV(m*this.m_correctionFactor,this.m_linearError,box2d.b2Vec2.s_t3),box2d.b2MotorJoint.prototype.SolveVelocityConstraints.s_Cdot);p=box2d.b2MulMV(this.m_linearMass,n,box2d.b2MotorJoint.prototype.SolveVelocityConstraints.s_impulse).SelfNeg();q=box2d.b2MotorJoint.prototype.SolveVelocityConstraints.s_oldImpulse.Copy(this.m_linearImpulse);
this.m_linearImpulse.SelfAdd(p);n=l*this.m_maxForce;this.m_linearImpulse.GetLengthSquared()>n*n&&(this.m_linearImpulse.Normalize(),this.m_linearImpulse.SelfMul(n));box2d.b2SubVV(this.m_linearImpulse,q,p);b.SelfMulSub(f,p);c-=h*box2d.b2CrossVV(r,p);d.SelfMulAdd(g,p);e+=k*box2d.b2CrossVV(t,p);a.velocities[this.m_indexA].w=c;a.velocities[this.m_indexB].w=e};box2d.b2MotorJoint.prototype.SolveVelocityConstraints.s_Cdot=new box2d.b2Vec2;box2d.b2MotorJoint.prototype.SolveVelocityConstraints.s_impulse=new box2d.b2Vec2;
...
Phaser.Physics.Box2D=function(a,b){this.game=a;this.ptmRatio=50;this.world=new box2d.b2World(new box2d.b2Vec2(0,0));this.debugDraw=new Phaser.Physics.Box2D.DefaultDebugDraw(this.mpx(1));this.world.SetDebugDraw(this.debugDraw);this.contactListener=new Phaser.Physics.Box2D.DefaultContactListener;this.world.SetContactListener(this.contactListener);this.nextFixtureId=this.nextBodyId=0;this.gravity=new Phaser.Physics.Box2D.PointProxy(this,this.world,this.world.GetGravity,this.world.SetGravity);this.friction=
.2;this.restitution=0;this.density=1;this.frameRate=1/60;this.velocityIterations=8;this.positionIterations=3;this.paused=this.useElapsedTime=!1;this.particleSystem=null;a=new box2d.b2BodyDef;this.mouseJointBody=this.world.CreateBody(a);this.mouseJoint=null;b.hasOwnProperty("mpx")&&b.hasOwnProperty("pxm")&&(this.mpx=b.mpx,this.pxm=b.pxm);this.walls={left:null,right:null,top:null,bottom:null};this.onBodyAdded=new Phaser.Signal;this.onBodyRemoved=new Phaser.Signal;this._toRemove=[];goog.inherits(Phaser.Physics.Box2D.RayCastCallback,
box2d.b2RayCastCallback);goog.inherits(Phaser.Physics.Box2D.QueryCallback,box2d.b2QueryCallback)};Phaser.Physics.Box2D.worldBoundsFilterCategory=32768;
...
Phaser.Physics.Box2D.QueryCallback.prototype.ReportFixture=function(a){var b={};b.body=a.GetBody().parent;b.fixture=a;this.hits.push(b);return!0};
Phaser.Physics.Box2D.renderBody=function(a,b,c,d){c=c||"rgb(255,255,255)";d=b.game.physics.box2d;b=b.data;var e=b.GetTransform();d.debugDraw.start(a);d.debugDraw.PushTransform(e);c=Phaser.Color.webToColor(c);a=d.debugDraw.color;a.r=c.r/255;a.g=c.g/255;a.b=c.b/255;for(c=b.GetFixtureList();c;c=c.GetNext())d.world.DrawShape(c,a);d.debugDraw.PopTransform();d.debugDraw.stop()};
...
b,c){if("undefined"===typeof a||4>a.length)return null;"undefined"===typeof b&&(b=0);"undefined"===typeof c&&(c=(a.length-b)/2);this.clearFixtures();return this.addPolygon(a,b,c)},loadPolygon:function(a,b,c,d){d=d?d:1;"undefined"===typeof c&&(c=null);a=this.game.cache.getPhysicsData(a,b);for(b=0;b<a.length;b++){for(var e=[],f=0;f<a[b].shape.length;f+=2)e.push(new box2d.b2Vec2(this.world.pxm(-a[b].shape[f])*d,this.world.pxm(-a[b].shape[f+1])*d));if(c)for(var f=this.world.pxm(-.5*c.width),g=this.world.pxm(-.5*
c.height),h=0;h<e.length;h++)e[h].x-=f,e[h].y-=g;f=new box2d.b2PolygonShape;f.Set(e,e.length);e=new box2d.b2FixtureDef;e.shape=f;e.friction=a[b].friction;e.restitution=a[b].bounce;e.density=a[b].density;e.filter.categoryBits=a[b].filter.categoryBits;e.filter.maskBits=a[b].filter.maskBits;this.data.CreateFixture(e).id=this.world.getNextFixtureId()}return!0},containsPoint:function(a){var b=this.world.pxm(-a.x);a=this.world.pxm(-a.y);b=new box2d.b2Vec2(b,a);for(a=this.data.GetFixtureList();a;a=a.GetNext())if(a.TestPoint(b))return!0;
...
Phaser.Physics.Box2D.DefaultContactListener.prototype.handleContactBeginOrEnd=function(a,b){var c=a.GetFixtureA(),d=a.GetFixtureB(),e=c.GetBody(),f=d.GetBody(),g=c.GetFilterData().categoryBits,h=d.GetFilterData().categoryBits,e=e.parent,f=f.parent,k=e.id,l=f.id;e._bodyContactCallbacks[l]&&e._bodyContactCallbacks[l].call(e._bodyContactCallbackContext[l],e,f,c,d,b,a);f._bodyContactCallbacks[k]&&f._bodyContactCallbacks[k].call(f._bodyContactCallbackContext[k],f,e,d,c,b,a);e._fixtureContactCallbacks[d.id]&&
e._fixtureContactCallbacks[d.id].call(e._fixtureContactCallbackContext[d.id],e,f,c,d,b,a);f._fixtureContactCallbacks[c.id]&&f._fixtureContactCallbacks[c.id].call(f._fixtureContactCallbackContext[c.id],f,e,d,c,b,a);e._fixtureContactCallbacks[c.id]&&e._fixtureContactCallbacks[c.id].call(e._fixtureContactCallbackContext[c.id],e,e,c,c,b,a);f._fixtureContactCallbacks[d.id]&&f._fixtureContactCallbacks[d.id].call(f._fixtureContactCallbackContext[d.id],f,f,d,d,b,a);e._categoryContactCallbacks[h]&&e._categoryContactCallbacks[h].call(e._categoryContactCallbackContext[h],
e,f,c,d,b,a);f._categoryContactCallbacks[g]&&f._categoryContactCallbacks[g].call(f._categoryContactCallbackContext[g],f,e,d,c,b,a);e._categoryContactCallbacks[g]&&e._categoryContactCallbacks[g].call(e._categoryContactCallbackContext[g],e,e,c,c,b,a);f._categoryContactCallbacks[h]&&f._categoryContactCallbacks[h].call(f._categoryContactCallbackContext[h],f,f,d,d,b,a)};
Phaser.Physics.Box2D.DefaultContactListener.prototype.PreSolve=function(a,b){var c=a.GetFixtureA(),d=a.GetFixtureB(),e=c.GetBody(),f=d.GetBody(),g=c.GetFilterData().categoryBits,h=d.GetFilterData().categoryBits,e=e.parent,f=f.parent,k=e.id,l=f.id;e._bodyPresolveCallbacks[l]&&e._bodyPresolveCallbacks[l].call(e._bodyPresolveCallbackContext[l],e,f,c,d,a,b);f._bodyPresolveCallbacks[k]&&f._bodyPresolveCallbacks[k].call(f._bodyPresolveCallbackContext[k],f,e,d,c,a,b);e._fixturePresolveCallbacks[d.id]&&e._fixturePresolveCallbacks[d.id].call(e._fixturePresolveCallbackContext[d.id],
...
Phaser.Physics.Box2D.Polygon.prototype.subPolygon=function(a,b){var c=new Phaser.Physics.Box2D.Polygon;if(!(a<b)){for(;a<this.vertices.length;a++)c.addVertex(this.at(a));a=0}for(;a<b+1;a++)c.addVertex(this.at(a));return c};
...
Phaser.Physics.Box2D.Polygon.prototype.decompose=function(a){"undefined"===typeof a&&(a=0);this.makeCCW();for(var b=[],c=Number.MAX_VALUE,d,e,f=!1,g=0;g<this.vertices.length;g++)if(this.isReflex(g))for(var f=!0,h=this.at(g),k=0;k<this.vertices.length;k++)if(this.canSee(g,k)){var l=this.at(k),m=l.x-h.x,l=l.y-h.y,m=m*m*l*l;m<c&&(d=g,e=k,c=m)}!f&&8<this.vertices.length&&(d=0,e=Math.floor(this.vertices.length/2),f=!0);f&&(b=this.subPolygon(d,e).decompose(a+1),a=this.subPolygon(e,d).decompose(a+1),b=b.concat(a));
0===b.length&&b.push(this.vertices);return b};
