var Bezier = function(t) {
    function r(i) {
        ...
        return t[i].call(e.exports, e, e.exports, r),
        e.loaded = !0,
        e.exports
    }
    var n = {};
    ...
    !function() {
        ...
        var e = Math.abs
          ...
          , p = function(t) {
            ...
            a && y.push("z"),
            this.dims = y,
            this.dimlen = y.length,
            function(t) {
                for (var r = t.order, n = t.points, i = l.align(n, {
                    p1: n[0],
                    p2: n[r]
                }), o = 0; o < i.length; o++)
                    if (e(i[o].y) > 1e-4)
        ...
        p.cubicFromPoints = function(t, n, i, e, o) {
            "undefined" == typeof e && (e = .5);
            var s = r(3, t, n, i, e);
            "undefined" == typeof o && (o = l.dist(n, s.C));
            var u = o * (1 - e) / e
              , a = l.dist(t, i)
              , f = (i.x - t.x) / a
              , c = (i.y - t.y) / a
        ...
        p.prototype = {
            ...
            toSVG: function(t) {
                if (this._3d)
                    return !1;
                for (var r = this.points, n = r[0].x, i = r[0].y, e = ["M", n, i, 2 === this.order ? "Q" : "C"], o = 1, s = r.length; s > o; o++)
                    e.push(r[o].x),
                    e.push(r[o].y);
                return e.join(" ")
            },
            update: function() {
                this._lut = [],
                this.dpoints = l.derive(this.points, this._3d),
                this.computedirection()
            },
            computedirection: function() {
                var t = this.points
                  , r = l.angle(t[0], t[this.order], t[1]);
                this.clockwise = r > 0
            },
            length: function() {
            ...
            on: function(t, r) {
                r = r || 5;
                for (var n, i = this.getLUT(), e = [], o = 0, s = 0; s < i.length; s++)
                    n = i[s],
                    l.dist(n, t) < r && (e.push(n),
                    o += s / i.length);
            ...
            project: function(t) {
                ...
                var a, s, f, c, h = (o - 1) / n, x = (o + 1) / n, y = .1 / n;
                for (e += 1,
                s = h,
                a = s; x + y > s; s += y)
                    f = this.compute(s),
            ...
            compute: function(t) {
                return l.compute(t, this.points, this._3d)
            },
            raise: function() {
            ...
            derivative: function(t) {
                ...
                return this._3d && (s.z = r * o[0].z + n * o[1].z + e * o[2].z),
                s
            },
            curvature: function(t) {
                return l.curvature(t, this.points, this._3d)
            },
            ...
            hull: function(t) {
                ...
                e[o++] = n[1],
                e[o++] = n[2],
                3 === this.order && (e[o++] = n[3]); n.length > 1; ) {
                    for (i = [],
                    s = 0,
                    u = n.length - 1; u > s; s++)
                        r = l.lerp(t, n[s], n[s + 1]),
                        e[o++] = r,
                        i.push(r);
                    n = i
                }
            ...
            split: function(t, r) {
                ...
                if (i.left._t1 = l.map(0, 0, 1, this._t1, this._t2),
                i.left._t2 = l.map(t, 0, 1, this._t1, this._t2),
                i.right._t1 = l.map(t, 0, 1, this._t1, this._t2),
                i.right._t2 = l.map(1, 0, 1, this._t1, this._t2),
                !r)
                    return i;
                r = l.map(r, t, 1, 0, 1);
            ...
            extrema: function() {
                ...
                return n.forEach(function(n) {
                    ...
                    i[n] = l.droots(t),
                    3 === this.order && (t = this.dpoints[1].map(r),
                    i[n] = i[n].concat(l.droots(t))),
                ...
                .bind(this)),
                e = e.sort(l.numberSort).filter(function(t, r) {
            ...
            simple: function() {
                if (3 === this.order) {
                    var t = l.angle(this.points[0], this.points[3], this.points[1])
                      , r = l.angle(this.points[0], this.points[3], this.points[2]);
                    if (t > 0 && 0 > r || 0 > t && r > 0)
                        return !1
                }
                var n = this.normal(0)
                        ...
                        for (i = n + o; 1 + o >= i; i += o)
                            ...
                            !r.simple()) {
                                ...
                                e(n - i) < o)
                                    return [];
                                r = t.split(n, i),
                                r._t1 = l.map(n, 0, 1, t._t1, t._t2),
                                r._t2 = l.map(i, 0, 1, t._t1, t._t2),
                                u.push(r),
                                n = i;
                                break
                            }
            ...
            scale: function(t) {
                ...
                var i = this.clockwise
                  ...
                  , u = l.lli4(s[0], s[0].c, s[1], s[1].c);
                if (!u)
                    throw new Error("cannot scale this curve. Try reducing it first.");
                var a = this.points
                  , f = [];
                return [0, 1].forEach(function(t) {
                    var n = f[t * r] = l.copy(a[t * r]);
                    n.x += (t ? o : e) * s[t].n.x,
                    n.y += (t ? o : e) * s[t].n.y
                }
                .bind(this)),
                ...
                .bind(this)),
                new p(f)) : ([0, 1].forEach(function(t) {
                    if (2 !== this.order || !t) {
                        var n = f[t * r]
                          , i = this.derivative(t)
                          , e = {
                ...
                function e(t, r, n, i, e) {
                    return function(o) {
                        var s = i / n
                          , u = (i + e) / n
                          , a = r - t;
                        return l.map(o, 0, 1, t + s * a, t + u * a)
                    }
                }
                r = "undefined" == typeof r ? t : r;
                var o, s = this.reduce(), u = s.length, a = [], f = [], c = 0, h = this.length(), x = "undefined" != typeof n && "undefined" != typeof i;
                s.forEach(function(o) {
                    _ = o.length(),
                    x ? (a.push(o.scale(e(t, n, h, c, _))),
                    f.push(o.scale(e(-r, -i, h, c, _)))) : (a.push(o.scale(t)),
                    f.push(o.scale(-r))),
                    c += _
                }),
                f = f.map(function(t) {
            ...
            outlineshapes: function(t, r, n) {
                r = r || t;
                for (var i = this.outline(t, r).curves, e = [], o = 1, s = i.length; s / 2 > o; o++) {
            ...
            intersects: function(t, r) {
                return t ? t.p1 && t.p2 ? this.lineIntersects(t) : (t instanceof p && (t = t.reduce()),
                this.curveintersects(this.reduce(), t, r)) : this.selfintersects(r)
            },
            lineIntersects: function(t) {
                ...
                return l.roots(this.points, t).filter(function(t) {
                    var o = u.get(t);
                    return l.between(o.x, r, i) && l.between(o.y, n, e)
                })
            },
            ...
            curveintersects: function(t, r, n) {
                ...
                return i.forEach(function(t) {
                    var r = l.pairiteration(t.left, t.right, n);
        ...
        var r = Math.abs
          ...
          , d = {
            ...
            arcfn: function(t, r) {
                var n = r(t)
                  , i = n.x * n.x + n.y * n.y;
                return "undefined" != typeof n.z && (i += n.z * n.z),
                u(i)
            },
            compute: function(t, r, n) {
                ...
                if (4 > i) {
                    ...
                    return n && (x.z = s * e[0].z + u * e[1].z + a * e[2].z + h * e[3].z),
                    x
                }
                for (var l = JSON.parse(JSON.stringify(r)); l.length > 1; ) {
                    for (var y = 0; y < l.length - 1; y++)
                        l[y] = {
                            x: l[y].x + (l[y + 1].x - l[y].x) * t,
                            y: l[y].y + (l[y + 1].y - l[y].y) * t
                        },
                        "undefined" != typeof l[y].z && (l[y] = l[y].z + (l[y + 1].z - l[y].z) * t);
                    l.splice(l.length - 1, 1)
                }
                return l[0]
            },
            derive: function(t, r) {
                for (var n = [], i = t, e = i.length, o = e - 1; e > 1; e--,
                o--) {
            ...
            between: function(t, r, n) {
                return t >= r && n >= t || d.approximately(t, r) || d.approximately(t, n)
            },
            ...
            lerp: function(t, r, n) {
                ...
                return r.z && n.z && (i.z = r.z + t * (n.z - r.z)),
                i
            },
            pointToString: function(t) {
                var r = t.x + "/" + t.y;
                return "undefined" != typeof t.z && (r += "/" + t.z),
                r
            },
            ...
            roots: function(t, r) {
                ...
                c /= l,
                x /= l;
                var M, v, S, k, j, e = (3 * c - a * a) / 3, O = e / 3, w = (2 * a * a * a - 9 * a * c + 27 * x) / 27, T = w / 2, C = T * T + O * O * O;
                if (0 > C) {
                    var L = -e / 3
                      , N = L * L * L
                      , A = u(N)
                      ...
                      , q = f(A)
                      , P = 2 * q;
                    return S = P * i(I / 3) - a / 3,
                    k = P * i((I + h) / 3) - a / 3,
                    j = P * i((I + 2 * h) / 3) - a / 3,
                    [S, k, j].filter(s)
                }
                if (0 === C)
                    return M = 0 > T ? f(-T) : -f(T),
                    S = 2 * M - a / 3,
                    k = -M - a / 3,
                    [S, k].filter(s);
                var Q = u(C);
            ...
            curvature: function(t, r, n) {
                var i, e, o = d.derive(r), s = o[0], f = o[1], c = d.compute(t, s), h = d.compute(t, f);
                return n ? (i = u(a(c.y * h.z - h.y * c.z, 2) + a(c.z * h.x - h.z * c.x, 2) + a(c.x * h.y - h.x * c.y, 2)),
                e = a(c.x * c.x + c.y * c.y + c.z * c.z, 1.5)) : (i = c.x * h.y - c.y * h.x,
                e = a(c.x * c.x + c.y * c.y, 1.5)),
                0 === i || 0 === e ? {
                    k: 0,
                    r: 0
                } : {
            ...
            pairiteration: function(t, r, n) {
                ...
                if (i.x.size + i.y.size < s && e.x.size + e.y.size < s)
                    return [(o * (t._t1 + t._t2) / 2 | 0) / o + "/" + (o * (r._t1 + r._t2) / 2 | 0) / o];
                var u = t.split(.5)
                  , a = r.split(.5)
                  , f = [{
                    left: u.left,
            ...
            getccenter: function(t, r, n) {
                var o, u = r.x - t.x, a = r.y - t.y, f = n.x - r.x, c = n.y - r.y, l = u * i(x) - a * e(x), y = u * e(x) + a * i(x), p = f * i(x) - c * e(x), v = f * e(x) + c * i(x), m = (t.x + r.x) / 2, g = (t.y + r.y) / 2, z = (r.x + n.x) / 2, b = (r.y + n.y) / 2, _ = m + l, w = g + y, E = z + p, M = b + v, S = d.lli8(m, g, _, w, z, b, E, M), k = d.dist(S, t), j = s(t.y - S.y, t.x - S.x), O = s(r.y - S.y, r.x - S.x), T = s(n.y - S.y, n.x - S.x);
                return T > j ? ((j > O || O > T) && (j += h),
                j > T && (o = T,
                T = j,
                j = o)) : O > T && j > O ? (o = T,
                T = j,
...
, function(t, r, n) {
    ...
    function e(t, r) {
        for (var n, e, s, u = o(r).split(" "), a = new RegExp("[MLCQZ]",""), f = [], c = {
            ...
            n = u.splice(0, 1)[0],
            a.test(n) && (s = u.splice(0, c[n]).map(parseFloat),
            e = i(t, n, s),
            e && f.push(e));
...
, function(t, r) {
    ...
    function n(t) {
        ...
        var r, n, i, e, o, s, u = t.replace(/([a-zA-Z])\s?/g, "|$1").split("|"), a = u.length, f = [], c = 0, h = 0, x = 0, l = 0, y = 0, p = 0, v = 0, d = 0, m = "";
        for (r = 1; a > r; r++)
            if (n = u[r],
            i = n.substring(0, 1),
            e = i.toLowerCase(),
